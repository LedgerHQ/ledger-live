...
Then, install a working ruby version for our apps (working at this time but may change at yours)
```sh
...
ruby --version
```
It should display the latest stable version installed by homebrew (`3.3.7` at our time)
```sh
