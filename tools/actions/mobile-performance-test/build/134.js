...
exports.ids = ["134"];
exports.modules = {
  "../../../node_modules/.pnpm/typanion@3.14.0/node_modules/typanion/lib/index.mjs"(
    ...
    const iso8601RegExp =
      /^(?:[1-9]\d{3}(-?)(?:(?:0[1-9]|1[0-2])\1(?:0[1-9]|1\d|2[0-8])|(?:0[13-9]|1[0-2])\1(?:29|30)|(?:0[13578]|1[02])(?:\1)31|00[1-9]|0[1-9]\d|[12]\d{2}|3(?:[0-5]\d|6[0-5]))|(?:[1-9]\d(?:0[48]|[2468][048]|[13579][26])|(?:[2468][048]|[13579][26])00)(?:(-?)02(?:\2)29|-?366))T(?:[01]\d|2[0-3])(:?)[0-5]\d(?:\3[0-5]\d)?(?:Z|[+-][01]\d(?:\3[0-5]\d)?)$/;

    function pushError({ errors, p } = {}, message) {
      errors === null || errors === void 0
        ? void 0
        : errors.push(`${p !== null && p !== void 0 ? p : `.`}: ${message}`);
      return false;
    }
      ...
      return makeValidator({
        test: (value, state) => {
          if (value !== expected)
            return pushError(
              state,
              `Expected ${getPrintable(expected)} (got ${getPrintable(value)})`,
            );
          return true;
        },
      });
    ...
    function isEnum(enumSpec) {
      ...
      const isAlphaNum = valuesArray.every(
        ...
        test: (value, state) => {
          if (!values.has(value)) {
            if (isAlphaNum) {
              return pushError(
                state,
                `Expected one of ${getPrintableArray(valuesArray, `or`)} (got ${getPrintable(value)})`,
              );
            } else {
              return pushError(
                state,
                `Expected a valid enumeration value (got ${getPrintable(value)})`,
              );
            }
          }
          return true;
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (typeof value !== `boolean`) {
            if (
              typeof (state === null || state === void 0 ? void 0 : state.coercions) !== `undefined`
            ) {
              if (
                typeof (state === null || state === void 0 ? void 0 : state.coercion) ===
                `undefined`
              )
              ...
              if (typeof value === `string`) {
                ...
                if (typeof val === `number`) {
                  if (JSON.stringify(val) === value) {
                    ...
                    return pushError(
                      state,
                      `Received a number that can't be safely represented by the runtime (${value})`,
                    );
                  }
                }
              }
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (
            ...
            return pushError(
              state,
              `The isPayload predicate can only be used with coercion enabled`,
            );
              ...
              if (typeof value === `string` && iso8601RegExp.test(value)) {
                ...
                if (typeof timestamp !== `undefined`) {
                  if (Number.isSafeInteger(timestamp) || !Number.isSafeInteger(timestamp * 1000)) {
                    ...
                    return pushError(
                      state,
                      `Received a timestamp that can't be safely represented by the runtime (${value})`,
                    );
                  }
                }
              }
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (Object.getPrototypeOf(value).toString() === `[object Set]`) {
            if (
              ...
              if (
                !isArrayValidator(
                  coercedValues,
                  Object.assign(Object.assign({}, state), { coercion: undefined }),
                )
              )
                return false;
              const updateValue = () =>
                coercedValues.some((val, t) => val !== originalValues[t])
              ...
              for (const subValue of value) {
                ...
                if (
                  !valid &&
                  (state === null || state === void 0 ? void 0 : state.errors) == null
                ) {
                  break;
                }
              }
          ...
          if (
            ...
            if (
              typeof (state === null || state === void 0 ? void 0 : state.coercion) === `undefined`
            )
              return pushError(state, `Unbound coercion result`);
            const store = { value };
            if (
        ...
        test: (value, state) => {
          ...
          if (Object.getPrototypeOf(value).toString() === `[object Map]`) {
            if (
              ...
              const updateValue = () =>
                coercedValues.some(
                  (val, t) => val[0] !== originalValues[t][0] || val[1] !== originalValues[t][1],
                )
              ...
              for (const [key, subValue] of value) {
                ...
                valid =
                  valueSpec(
                    subValue,
                    Object.assign(Object.assign({}, state), { p: computeKey(state, key) }),
                  ) && valid;
                if (
                  !valid &&
                  (state === null || state === void 0 ? void 0 : state.errors) == null
            ...
            if (Array.isArray(value)) {
              ...
              state.coercions.push([
                ...
                makeLazyCoercionFn(
                  state.coercion,
                  value,
                  () => new Map(Object.entries(store.value)),
                ),
              ]);
              return true;
            }
    ...
    function isRecord(spec, { keys: keySpec = null } = {}) {
      const isArrayValidator = isArray(
        isTuple([keySpec !== null && keySpec !== void 0 ? keySpec : isString(), spec]),
      );
      return makeValidator({
        test: (value, state) => {
          var _a;
          ...
          let valid = true;
          for (
            let t = 0, T = keys.length;
            t < T &&
            (valid || (state === null || state === void 0 ? void 0 : state.errors) != null);
            ++t
          ) {
            const key = keys[t];
            const sub = value[key];
      ...
      makeValidator({
        test: (value, state) => {
          if (!(value instanceof constructor))
            return pushError(
              state,
              `Expected an instance of ${constructor.name} (got ${getPrintable(value)})`,
            );
          return true;
        },
      });
     ...
     */
    const isOneOf = (specs, { exclusive = false } = {}) =>
      makeValidator({
        test: (value, state) => {
          var _a, _b, _c;
          const matches = [];
          const errorBuffer =
            typeof (state === null || state === void 0 ? void 0 : state.errors) !== `undefined`
              ? []
              : undefined;
          for (let t = 0, T = specs.length; t < T; ++t) {
            ...
            if (
              ...
              errorBuffer === null || errorBuffer === void 0
                ? void 0
          ...
          if (matches.length === 1) {
            ...
            if (typeof subCoercions !== `undefined`)
              (_b = state === null || state === void 0 ? void 0 : state.coercions) === null ||
              _b === void 0
                ? void 0
                : _b.push(...subCoercions);
            return true;
          }
          if (matches.length > 1)
            pushError(
              state,
              `Expected to match exactly a single predicate (matched ${matches.join(`, `)})`,
            );
          else
            (_c = state === null || state === void 0 ? void 0 : state.errors) === null ||
            _c === void 0
              ? void 0
              : _c.push(...errorBuffer);
          return false;
      ...
      return makeValidator({
        test: (value, state) => {
          if (!(value.length >= length))
            return pushError(
              state,
              `Expected to have a length of at least ${length} elements (got ${value.length})`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          if (!(value.length <= length))
            return pushError(
              state,
              `Expected to have a length of at most ${length} elements (got ${value.length})`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          if (!(value.length === length))
            return pushError(
              state,
              `Expected to have a length of exactly ${length} elements (got ${value.length})`,
            );
          return true;
        },
      });
        ...
        test: (value, state) => {
          ...
          for (let t = 0, T = value.length; t < T; ++t) {
            ...
            if (set.has(key)) {
              ...
              pushError(
                state,
                `Expected to contain unique elements; got a duplicate with ${getPrintable(value)}`,
              );
              dup.add(key);
            } else {
              set.add(key);
      ...
      return makeValidator({
        test: (value, state) => {
          if (!regExp.test(value))
            return pushError(
              state,
              `Expected to match the pattern ${regExp.toString()} (got ${getPrintable(value)})`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          if (!iso8601RegExp.test(value))
            return pushError(
              state,
              `Expected to be a valid ISO 8601 date string (got ${getPrintable(value)})`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (!res)
            return pushError(
              state,
              `Expected to be a valid hexadecimal color string (got ${getPrintable(value)})`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          if (!base64RegExp.test(value))
            return pushError(
              state,
              `Expected to be a valid base 64 string (got ${getPrintable(value)})`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          try {
            ...
            return pushError(
              state,
              `Expected to be a valid JSON string (got ${getPrintable(value)})`,
            );
          }
    ...
    function cascade(spec, ...followups) {
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          const reverts = [];
          if (typeof subCoercions !== `undefined`)
            for (const [, coercion] of subCoercions) reverts.push(coercion());
          try {
            if (
              typeof (state === null || state === void 0 ? void 0 : state.coercions) !== `undefined`
            ) {
    ...
    function hasRequiredKeys(requiredKeys, options) {
      ...
      const check =
        checks[
          (_a = options === null || options === void 0 ? void 0 : options.missingIf) !== null &&
          _a !== void 0
            ? _a
            : "missing"
        ];
      return makeValidator({
        test: (value, state) => {
          ...
          if (problems.length > 0)
            return pushError(
              state,
              `Missing required ${plural(problems.length, `property`, `properties`)} ${getPrintableArray(problems, `and`)}`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (!valid)
            return pushError(
              state,
              `Missing at least one property from ${getPrintableArray(Array.from(requiredSet), `or`)}`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (problems.length > 0)
            return pushError(
              state,
              `Forbidden ${plural(problems.length, `property`, `properties`)} ${getPrintableArray(problems, `and`)}`,
            );
          return true;
        },
      });
      ...
      return makeValidator({
        test: (value, state) => {
          ...
          if (used.length > 1)
            return pushError(
              state,
              `Mutually exclusive properties ${getPrintableArray(used, `and`)}`,
            );
          return true;
        },
      });
    ...
    function hasKeyRelationship(subject, relationship, others, options) {
      ...
      const skipped = new Set(
        (_a = options === null || options === void 0 ? void 0 : options.ignore) !== null &&
          _a !== void 0
          ? _a
          : [],
      );
      const check =
        checks[
          (_b = options === null || options === void 0 ? void 0 : options.missingIf) !== null &&
          _b !== void 0
            ? _b
            : "missing"
        ];
