...
exports.ids = ["699"];
exports.modules = {
  "../../../node_modules/.pnpm/@aws-sdk+credential-provider-http@3.535.0/node_modules/@aws-sdk/credential-provider-http/dist-es/index.js"(
    ...
    const checkUrl = url => {
      ...
      if (url.hostname.includes("[")) {
        if (
          "[::1]" === url.hostname ||
          "[0000:0000:0000:0000:0000:0000:0000:0001]" === url.hostname
        )
          return;
      } else {
  ...
  - EKS container host 169.254.170.23 or [fd00:ec2::23]`);
    ...
    var util_stream_dist_es = __webpack_require__(
    ...
    async function getCredentials(response) {
      ...
      if (!contentType.includes("json"))
        console.warn(
          "HTTP credential provider response header content-type was not application/json. Observed: " +
            contentType +
            ".",
        );
      ...
      if (200 === response.statusCode) {
        ...
        if (
          "string" != typeof parsed.AccessKeyId ||
          "string" != typeof parsed.SecretAccessKey ||
          "string" != typeof parsed.Token ||
          "string" != typeof parsed.Expiration
        )
      ...
      if (response.statusCode >= 400 && response.statusCode < 500) {
        ...
        throw Object.assign(
          new property_provider_dist_es.C1(`Server responded with status: ${response.statusCode}`),
          {
    ...
    const fromHttp = options => {
      ...
      if (full) host = full;
        ...
        throw new property_provider_dist_es.C1(`No HTTP credential provider host provided.
        ...
        async () => {
          ...
          if (token) request.headers.Authorization = token;
            ...
            request.headers.Authorization = (
              await promises_default().readFile(tokenFile)
            ).toString();
          try {
