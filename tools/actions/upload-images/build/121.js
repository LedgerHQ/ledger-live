  ...
  "../../../node_modules/.pnpm/@smithy+credential-provider-imds@2.3.0/node_modules/@smithy/credential-provider-imds/dist-es/index.js"(
    ...
    function httpRequest(options) {
      return new Promise((resolve, reject) => {
        ...
        req.on("error", err => {
          reject(
            Object.assign(new dist_es.mZ("Unable to connect to instance metadata service"), err),
          );
          req.destroy();
        });
        req.on("timeout", () => {
        ...
        req.on("response", res => {
          ...
          if (statusCode < 200 || 300 <= statusCode) {
            reject(
              Object.assign(
                new dist_es.mZ("Error response received from instance metadata service"),
                {
                  statusCode,
                },
              ),
    ...
    const isImdsCredentials = arg =>
      Boolean(arg) &&
      "object" == typeof arg &&
      "string" == typeof arg.AccessKeyId &&
      "string" == typeof arg.SecretAccessKey &&
      "string" == typeof arg.Token &&
      "string" == typeof arg.Expiration;
      ...
      return () =>
        retry(async () => {
          ...
          if (!isImdsCredentials(credsResponse))
            throw new dist_es.C1("Invalid response received from instance metadata service.");
    ...
    const getInstanceMetadataEndpoint = async () =>
      (0, url_parser_dist_es.D)(
        (await getFromEndpointConfig()) || (await getFromEndpointModeConfig()),
      );
    const getFromEndpointConfig = async () =>
      (0, node_config_provider_dist_es.Z)(ENDPOINT_CONFIG_OPTIONS)();
    const getFromEndpointModeConfig = async () => {
      const endpointMode = await (0, node_config_provider_dist_es.Z)(
      ...
      switch (endpointMode) {
        ...
        default:
          throw new Error(
            `Unsupported endpoint mode: ${endpointMode}. Select from ${Object.values(EndpointMode_EndpointMode)}`,
          );
      }
    };
      ...
      return async () => {
        ...
        }
        {
          ...
          try {
            ...
            if ("TimeoutError" === error.message || [403, 404, 405].includes(error.statusCode))
