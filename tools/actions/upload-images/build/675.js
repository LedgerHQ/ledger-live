...
exports.ids = ["675"];
exports.modules = {
  "../../../node_modules/.pnpm/@aws-sdk+client-sts@3.540.0_@aws-sdk+credential-provider-node@3.540.0/node_modules/@aws-sdk/client-sts/dist-es/defaultRoleAssumers.js"(
    ...
    var dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+middleware-endpoint@2.5.0/node_modules/@smithy/middleware-endpoint/dist-es/index.js",
    );
    var serdePlugin = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+middleware-serde@2.3.0/node_modules/@smithy/middleware-serde/dist-es/serdePlugin.js",
    );
    var smithy_client_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+smithy-client@2.5.0/node_modules/@smithy/smithy-client/dist-es/index.js",
    );
    ...
    var parseXmlBody = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/protocols/xml/parseXmlBody.js",
    );
    var protocol_http_dist_es = __webpack_require__(
    ...
    const de_Credentials = (output, context) => {
      ...
      if (null != output[_E])
        contents[_E] = (0, smithy_client_dist_es.Y0)((0, smithy_client_dist_es.t_)(output[_E]));
      return contents;
    };
    ...
    const buildFormUrlencodedString = formEntries =>
      Object.entries(formEntries)
        .map(
          ([key, value]) =>
            (0, smithy_client_dist_es.$6)(key) + "=" + (0, smithy_client_dist_es.$6)(value),
        )
        .join("&");
    ...
    class AssumeRoleCommand extends smithy_client_dist_es.uB
      .classBuilder()
      .ep({
        ...commonParams,
      })
      ...
      .build() {}
    class AssumeRoleWithWebIdentityCommand extends smithy_client_dist_es.uB
      .classBuilder()
      .ep({
        ...commonParams,
      })
    ...
    const resolveRegion = async (_region, _parentRegion, credentialProviderLogger) => {
      ...
      const parentRegion =
        "function" == typeof _parentRegion ? await _parentRegion() : _parentRegion;
    ...
    var middleware_user_agent_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+middleware-user-agent@3.540.0/node_modules/@aws-sdk/middleware-user-agent/dist-es/index.js",
    );
    var config_resolver_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+config-resolver@2.2.0/node_modules/@smithy/config-resolver/dist-es/index.js",
    );
    var core_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+core@1.4.0/node_modules/@smithy/core/dist-es/index.js",
    );
    var middleware_content_length_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+middleware-content-length@2.2.0/node_modules/@smithy/middleware-content-length/dist-es/index.js",
    );
    var middleware_retry_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+middleware-retry@2.2.0/node_modules/@smithy/middleware-retry/dist-es/index.js",
    );
    var resolveAwsSdkSigV4Config = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/httpAuthSchemes/aws_sdk/resolveAwsSdkSigV4Config.js",
    );
    var util_middleware_dist_es = __webpack_require__(
    ...
    const defaultSTSHttpAuthSchemeParametersProvider = async (config, context, input) => ({
      ...
      region:
        (await (0, util_middleware_dist_es.t)(config.region)()) ||
        (() => {
    ...
    const credentialDefaultProvider_defaultProvider = input => () =>
      Promise.resolve()
        .then(
          __webpack_require__.bind(
            __webpack_require__,
            "../../../node_modules/.pnpm/@aws-sdk+credential-provider-node@3.540.0/node_modules/@aws-sdk/credential-provider-node/dist-es/index.js",
          ),
        )
        .then(({ defaultProvider }) => defaultProvider(input)());
    var emitWarningIfUnsupportedVersion = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/client/emitWarningIfUnsupportedVersion.js",
    );
    var AwsSdkSigV4Signer = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/httpAuthSchemes/aws_sdk/AwsSdkSigV4Signer.js",
    );
    var util_user_agent_node_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+util-user-agent-node@3.535.0/node_modules/@aws-sdk/util-user-agent-node/dist-es/index.js",
    );
    var hash_node_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+hash-node@2.2.0/node_modules/@smithy/hash-node/dist-es/index.js",
    );
    var node_config_provider_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+node-config-provider@2.3.0/node_modules/@smithy/node-config-provider/dist-es/index.js",
    );
    var node_http_handler_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+node-http-handler@2.5.0/node_modules/@smithy/node-http-handler/dist-es/index.js",
    );
    var util_body_length_node_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+util-body-length-node@2.3.0/node_modules/@smithy/util-body-length-node/dist-es/index.js",
    );
    var util_retry_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+util-retry@2.2.0/node_modules/@smithy/util-retry/dist-es/index.js",
    );
    var url_parser_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+url-parser@2.2.0/node_modules/@smithy/url-parser/dist-es/index.js",
    );
    var util_base64_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+util-base64@2.3.0/node_modules/@smithy/util-base64/dist-es/index.js",
    );
    var util_utf8_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+util-utf8@2.3.0/node_modules/@smithy/util-utf8/dist-es/index.js",
    );
    var util_endpoints_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+util-endpoints@3.540.0/node_modules/@aws-sdk/util-endpoints/dist-es/index.js",
    );
    var _smithy_util_endpoints_dist_es = __webpack_require__(
    ...
    const defaultEndpointResolver = (endpointParams, context = {}) =>
      (0, _smithy_util_endpoints_dist_es.sO)(ruleSet, {
    ...
    var util_defaults_mode_node_dist_es = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+util-defaults-mode-node@2.3.0/node_modules/@smithy/util-defaults-mode-node/dist-es/index.js",
    );
    const runtimeConfig_getRuntimeConfig = config => {
      ...
      return {
        ...
        credentialDefaultProvider:
          config?.credentialDefaultProvider ?? credentialDefaultProvider_defaultProvider,
        defaultUserAgentProvider:
          config?.defaultUserAgentProvider ??
          (0, util_user_agent_node_dist_es.mJ)({
        ...
        httpAuthSchemes: config?.httpAuthSchemes ?? [
          {
            ...
            identityProvider: ipc =>
              ...
              (async idProps =>
                await credentialDefaultProvider_defaultProvider(idProps?.__config || {})()),
            signer: new AwsSdkSigV4Signer.f(),
          },
          {
            schemeId: "smithy.api#noAuth",
        ...
        maxAttempts:
          config?.maxAttempts ?? (0, node_config_provider_dist_es.Z)(middleware_retry_dist_es.qs),
        region:
          config?.region ??
          (0, node_config_provider_dist_es.Z)(
            config_resolver_dist_es.GG,
            config_resolver_dist_es.zH,
          ),
        requestHandler: node_http_handler_dist_es.$c.create(
        ...
        useDualstackEndpoint:
          ...
          (0, node_config_provider_dist_es.Z)(config_resolver_dist_es.e$),
        useFipsEndpoint:
          config?.useFipsEndpoint ??
          (0, node_config_provider_dist_es.Z)(config_resolver_dist_es.Ko),
      };
    };
    var dist_es_extensions = __webpack_require__(
    ...
    const defaultRoleAssumers_getDefaultRoleAssumer = (stsOptions = {}, stsPlugins) =>
      getDefaultRoleAssumer(stsOptions, getCustomizableStsClientCtor(STSClient, stsPlugins));
    const defaultRoleAssumers_getDefaultRoleAssumerWithWebIdentity = (
      stsOptions = {},
      stsPlugins,
    ) =>
      getDefaultRoleAssumerWithWebIdentity(
        stsOptions,
        getCustomizableStsClientCtor(STSClient, stsPlugins),
      );
  },
  "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/httpAuthSchemes/aws_sdk/AwsSdkSigV4Signer.js"(
    __unused_rspack_module,
    ...
    const getDateHeader = response =>
      dist_es.cS.isInstance(response) ? (response.headers?.date ?? response.headers?.Date) : void 0;
    ...
    class AwsSdkSigV4Signer {
      async sign(httpRequest, identity, signingProperties) {
        if (!dist_es.Kd.isInstance(httpRequest))
  ...
  "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/httpAuthSchemes/aws_sdk/resolveAwsSdkSigV4Config.js"(
    ...
    var _smithy_core__rspack_import_0 = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+core@1.4.0/node_modules/@smithy/core/dist-es/index.js",
    );
    var _smithy_signature_v4__rspack_import_1 = __webpack_require__(
      "../../../node_modules/.pnpm/@smithy+signature-v4@2.2.0/node_modules/@smithy/signature-v4/dist-es/index.js",
    );
    const resolveAwsSdkSigV4Config = config => {
      let normalizedCreds;
      if (config.credentials)
        normalizedCreds = (0, _smithy_core__rspack_import_0.K4)(
          config.credentials,
          _smithy_core__rspack_import_0.OC,
          _smithy_core__rspack_import_0.e,
        );
      if (!normalizedCreds)
        normalizedCreds = config.credentialDefaultProvider
          ? (0, _smithy_core__rspack_import_0.te)(
      ...
      signer = config.signer
        ? (0, _smithy_core__rspack_import_0.te)(config.signer)
        : config.regionInfoProvider
          ? () =>
              (0, _smithy_core__rspack_import_0.te)(config.region)()
                .then(async region => [
                ...
                .then(([regionInfo, region]) => {
                  ...
                  const SignerCtor =
                    config.signerConstructor || _smithy_signature_v4__rspack_import_1.BB;
