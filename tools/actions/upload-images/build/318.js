...
exports.modules = {
  ...
  "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/protocols/json/parseJsonBody.js"(
    __unused_rspack_module,
    __webpack_exports__,
    __webpack_require__,
  ) {
    ...
    var _common__rspack_import_0 = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/protocols/common.js",
    );
    const parseJsonBody = (streamBody, context) =>
      (0, _common__rspack_import_0.w)(streamBody, context).then(encoded => {
        if (encoded.length)
          try {
  ...
  "../../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.540.0_@aws-sdk+credential-provider-node@3.540.0/node_modules/@aws-sdk/credential-provider-sso/dist-es/loadSso.js"(
    ...
    var parseJsonBody = __webpack_require__(
      "../../../node_modules/.pnpm/@aws-sdk+core@3.535.0/node_modules/@aws-sdk/core/dist-es/protocols/json/parseJsonBody.js",
    );
    ...
    const se_GetRoleCredentialsCommand = async (input, context) => {
      ...
      const query = (0, smithy_client_dist_es.Tj)({
        [_rn]: [, (0, smithy_client_dist_es.Y0)(input[_rN], "roleName")],
        [_ai]: [, (0, smithy_client_dist_es.Y0)(input[_aI], "accountId")],
      });
      let body;
    ...
    const de_GetRoleCredentialsCommand = async (output, context) => {
      ...
      const data = (0, smithy_client_dist_es.Y0)(
        (0, smithy_client_dist_es.Xk)(await (0, parseJsonBody.Y2)(output.body, context)),
        "body",
      );
    ...
    const isSerializableHeaderValue = value =>
      null != value &&
      "" !== value &&
      (!Object.getOwnPropertyNames(value).includes("length") || 0 != value.length) &&
      (!Object.getOwnPropertyNames(value).includes("size") || 0 != value.size);
    const _aI = "accountId";
    ...
    class GetRoleCredentialsCommand extends smithy_client_dist_es.uB
      .classBuilder()
      .ep({
        ...commonParams,
      })
