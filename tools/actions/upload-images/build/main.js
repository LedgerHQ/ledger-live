...
// ../../../node_modules/.pnpm/isomorphic-unfetch@3.1.0/node_modules/isomorphic-unfetch/index.js
var require_isomorphic_unfetch = __commonJS({
  "../../../node_modules/.pnpm/isomorphic-unfetch@3.1.0/node_modules/isomorphic-unfetch/index.js"(exports2, module2) {
    function r(m) {
      return m && m.default || m;
    }
    module2.exports = global.fetch = global.fetch || (typeof process == "undefined" ? r((init_unfetch_module(), __toCommonJS(unfetch_module_exports))) : function(url, opts) {
      return r((init_lib(), __toCommonJS(lib_exports)))(String(url).replace(/^\/\//g, "https://"), opts);
    });
  }
});
...
var uploadImage = () => __async(exports, null, function* () {
  ...
  const upload = (file, i = 0) => __async(exports, null, function* () {
    if (i > 2) {
      return "error";
    }
    ...
    try {
      const res = yield (0, import_isomorphic_unfetch.default)("https://api.imgur.com/3/image", {
        method: "POST",
        headers: {
      ...
      const link = (yield res.json()).data.link;
      if (!link) {
