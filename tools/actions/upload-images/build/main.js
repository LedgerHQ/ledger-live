...
var require_isomorphic_unfetch = __commonJS({
  "../../../node_modules/.pnpm/isomorphic-unfetch@3.1.0/node_modules/isomorphic-unfetch/index.js"(exports, module2) {
    function r(m) {
...
var uploadImage = async () => {
  ...
  const upload = async (file, i = 0) => {
    ...
    try {
      const res = await (0, import_isomorphic_unfetch.default)("https://api.imgur.com/3/image", {
        method: "POST",
        headers: {
