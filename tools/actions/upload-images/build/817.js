...
exports.modules = {
  "../../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.540.0_@aws-sdk+credential-provider-node@3.540.0/node_modules/@aws-sdk/credential-provider-sso/dist-es/index.js"(
    ...
    var shared_ini_file_loader_dist_es = __webpack_require__(
      ...
      const { SSOOIDCClient } = await __webpack_require__
        ...
        .then(
          __webpack_require__.bind(
            __webpack_require__,
            "../../../node_modules/.pnpm/@aws-sdk+token-providers@3.540.0_@aws-sdk+credential-provider-node@3.540.0/node_modules/@aws-sdk/token-providers/dist-es/loadSsoOidc.js",
          ),
        );
    ...
    const validateTokenExpiry = token => {
      if (token.expiration && token.expiration.getTime() < Date.now())
        throw new dist_es.Jh(`Token is expired. ${REFRESH_MESSAGE}`, false);
    };
    const validateTokenKey = (key, value, forRefresh = false) => {
      if (void 0 === value)
        throw new dist_es.Jh(
    ...
    const resolveSSOCredentials = async ({
      ...
      const { SSOClient, GetRoleCredentialsCommand } = await __webpack_require__
        .e("318")
        .then(
          __webpack_require__.bind(
            __webpack_require__,
            "../../../node_modules/.pnpm/@aws-sdk+credential-provider-sso@3.540.0_@aws-sdk+credential-provider-node@3.540.0/node_modules/@aws-sdk/credential-provider-sso/dist-es/loadSso.js",
          ),
        );
      const sso =
        ssoClient ||
      ...
      async () => {
            ...
            );
        {
          ...
          if (!isSsoProfile(profile))
            throw new dist_es.C1(`Profile ${profileName} is not configured with SSO credentials.`);
          if (profile?.sso_session) {
            const ssoSessions = await (0, shared_ini_file_loader_dist_es.qw)(init);
            const session = ssoSessions[profile.sso_session];
            const conflictMsg = ` configurations in profile ${profileName} and sso-session ${profile.sso_session}`;
            if (ssoRegion && ssoRegion !== session.sso_region)
              throw new dist_es.C1("Conflicting SSO region" + conflictMsg, false);
            if (ssoStartUrl && ssoStartUrl !== session.sso_start_url)
              throw new dist_es.C1("Conflicting SSO start_url" + conflictMsg, false);
