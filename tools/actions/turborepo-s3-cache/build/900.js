...
exports.modules = {
    "../../../node_modules/.pnpm/@aws-sdk+client-sts@3.651.1/node_modules/@aws-sdk/client-sts/dist-es/index.js" (__unused_rspack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.d(__webpack_exports__, {
            ...
            getDefaultRoleAssumer: ()=>defaultRoleAssumers_getDefaultRoleAssumer
        });
        ...
        class AssumeRoleCommand extends smithy_client_dist_es.uB.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
            return [
        ...
        class AssumeRoleWithWebIdentityCommand extends smithy_client_dist_es.uB.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
            return [
                (0, serdePlugin.TM)(config, this.serialize, this.deserialize),
                (0, dist_es.rD)(config, Command.getEndpointParameterInstructions())
            ];
        ...
        const getAccountIdFromAssumedRoleUser = (assumedRoleUser)=>{
            if ("string" == typeof assumedRoleUser?.Arn) {
        ...
        const isH2 = (requestHandler)=>requestHandler?.metadata?.handlerProtocol === "h2";
        ...
        const runtimeConfig_getRuntimeConfig = (config)=>{
            ...
            return {
                ...
                httpAuthSchemes: config?.httpAuthSchemes ?? [
                    {
                        schemeId: "aws.auth#sigv4",
                        identityProvider: (ipc)=>ipc.getIdentityProvider("aws.auth#sigv4") || (async (idProps)=>await (0, credential_provider_node_dist_es.v6)(idProps?.__config || {})()),
                        signer: new AwsSdkSigV4Signer.f2()
                    },
                    {
                        schemeId: "smithy.api#noAuth",
