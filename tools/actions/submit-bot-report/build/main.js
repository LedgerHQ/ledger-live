...
async function main() {
  ...
  const slackCommentTemplateP = fs2.promises.readFile(
  ...
  for (const uri of commentAPIs) {
    ...
    try {
      const fullReportBodyP = fs2.promises.readFile(
