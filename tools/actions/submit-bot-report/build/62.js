...
exports.modules = {
  "../../../node_modules/.pnpm/node-fetch@3.3.2/node_modules/node-fetch/src/utils/multipart-parser.js"(
    ...
    var fetch_blob_from_js__rspack_import_0 = __webpack_require__(
      "../../../node_modules/.pnpm/fetch-blob@3.2.0/node_modules/fetch-blob/from.js",
    );
    var formdata_polyfill_esm_min_js__rspack_import_1 = __webpack_require__(
    ...
    async function toFormData(Body, ct) {
      ...
      let filename;
      const entryChunks = [];
      const formData = new formdata_polyfill_esm_min_js__rspack_import_1.fS();
      ...
      const appendFileToFormData = () => {
        const file = new fetch_blob_from_js__rspack_import_0.ZH(entryChunks, filename, {
          type: contentType,
        });
