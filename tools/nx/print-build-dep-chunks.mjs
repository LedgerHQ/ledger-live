 ...
 * (leaves first), split into chunkCount comma-separated chunks (one per line).
 ...
 * node:fs/promises.readFile with no concurrency cap — see
 * node_modules/.pnpm/@nx+s3-cache@5.0.2_nx@22.5.1/node_modules/@nx/s3-cache/index.js
 * lines 170-214. Splitting into smaller nx invocations bounds the per-task
 * fd burst.
 */
