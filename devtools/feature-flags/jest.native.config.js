module.exports = {
  ...
  transformIgnorePatterns: [
    "node_modules/(?!(.pnpm|(jest-)?react-native|react-native-safe-area-context|react-native-reanimated|react-native-worklets|react-native-screens|@react-native(-community)?|@gorhom/bottom-sheet|@ledgerhq/lumen-.*|immer)/.)",
  ],
  modulePaths: ["<rootDir>"],
  moduleNameMapper: {
