 ...
 * @memberof mock/account
 */
export function genOperation(account: Account, ops: *, currency: Currency, rng: Prando): Operation {
  ...
  return {
    ...
    hash: genHex(64, rng),
    date,
    blockHeight: account.lastBlockHeight - Math.floor((Date.now() - date) / 900000),
  }
}
