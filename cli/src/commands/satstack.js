...
export default {
  ...
  args: [
    ...
    { name: "rpcUSER", type: String, desc: "username of full node" },
    { name: "rpcPASSWORD", type: String, desc: "password of full node" },
    { name: "rpcTLS", type: Boolean, desc: "use tls in full node" },
  ],
  job: ({
    "no-device": noDevice,
    "no-save": noSave,
