...
import { PersistedIdentities } from "@domain/entity-client-identity";
...
export function getMarketBannerState(): Promise<MarketBannerState | null> {
  return storage.get("marketBanner") as Promise<MarketBannerState | null>;
}
