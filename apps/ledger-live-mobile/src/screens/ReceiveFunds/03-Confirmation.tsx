...
function ReceiveConfirmationInner({ navigation, route, account, parentAccount }: Props) {
  ...
  const CustomConfirmationAlert = useReceiveConfirmationPostAlert(cryptoFamily) as
    | React.ComponentType<any> // eslint-disable-line @typescript-eslint/no-explicit-any
    | undefined;
  const CustomConfirmationTokenAlert = useReceiveConfirmationTokenAlert(tokenParentFamily) as
    | React.ComponentType<any> // eslint-disable-line @typescript-eslint/no-explicit-any
    | undefined;
