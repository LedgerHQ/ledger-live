...
export default function Content({
  ...
  const bridge = useAccountBridge(mainAccount, parentAccount);
  ...
  const isEditable = bridge.isEditableOperation?.(mainAccount, operation) ?? false;
  const isOperationStuck = bridge.isStuckOperation?.(operation) ?? false;
