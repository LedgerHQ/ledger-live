...
import type { SignRawTransactionNavigatorParamList } from "~/components/RootNavigator/types/SignRawTransactionNavigator";
...
export default function ValidationError({ navigation, route }: Navigation) {
  ...
  return (
    ...
    >
      <TrackScreen category="SignRawTransaction" name="ValidationError" />
