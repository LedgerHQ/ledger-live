...
function KnownDeviceCard({ device }: { device: KnownDevice }) {
  return (
...
function DisplayedDeviceCard({ device }: { device: DisplayedDevice }) {
  return (
    <Flex p={3} backgroundColor="neutral.c30" borderRadius={8} mb={3}>
      <Text variant="body" fontWeight="semiBold" mb={2}>
...
function StateHistoryCard({ entry }: { entry: StateHistoryEntry }) {
  return (
