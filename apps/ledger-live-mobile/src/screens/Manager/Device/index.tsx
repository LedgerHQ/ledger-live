...
import { isDeviceLocalizationSupported } from "@ledgerhq/live-common/lib/manager/localization";
import { idsToLanguage } from "@ledgerhq/live-common/lib/types/languages";
