...
const useNpsRatings = () => {
  const ratingsFeature = useFeature("npsRatingsPrompt");
  ...
  const handleSettingsRateApp = useCallback(() => {
    ...
    setRatingsModalOpenCallback(true);
  }, [isPushNotificationsModalOpen, dispatch, setRatingsModalOpenCallback]);
