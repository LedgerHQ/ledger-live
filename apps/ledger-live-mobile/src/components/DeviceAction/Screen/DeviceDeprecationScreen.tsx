...
export const DeviceDeprecationScreen = ({
  ...
  return (
    <Wrapper style={{ width: "100%" }}>
      ...
      >
        <CircleIcon>{mapedIcon[screenName]}</CircleIcon>
        <Text fontWeight="semiBold" textAlign="center" fontSize={24} mt={6}>
          {mapedTitle[screenName]}
        </Text>
        <Text
          color="opacityDefault.c70"
          textAlign="center"
          fontWeight="medium"
          fontSize={14}
          mt={4}
        >
          <Trans i18nKey={mapedSubTitleKey[screenName]} />
        </Text>
        ...
        {screenName === DeviceDeprecationScreens.warningScreen ? (
          <Flex backgroundColor="neutral.c30" p={5} mt={5} borderRadius={5} alignSelf="stretch">
            <Checkbox
              checked={isChecked}
