...
describe("DeviceAction - Deprecation", () => {
  it("should render deprecation warning and deprecation clear signing warning", async () => {
  ...
  it("should render deprecation warning only", async () => {
    const mockOnContinue = jest.fn();
    const deviceDeprecationRules: DeviceDeprecationRules = {
      modelId: DeviceModelId.nanoS,
      warningScreenVisible: true,
  ...
  it("should render deprecation clear signing warning only", async () => {
    const mockOnContinue = jest.fn();
    const deviceDeprecationRules: DeviceDeprecationRules = {
      modelId: DeviceModelId.nanoS,
