...
const StaxToNano = (
  <Svg width={283} height={144} fill="none">
    <Path
      fill="#fff"
      fillRule="evenodd"
      d="M82 48H55v9.5h-1v-10a1.5 1.5 0 0 1 1.5-1.5H82a5 5 0 0 1 5 5v43a5 5 0 0 1-5 5H55.5a1.5 1.5 0 0 1-1.5-1.5V97h28a3 3 0 0 0 3-3V51a3 3 0 0 0-3-3Z"
      clipRule="evenodd"
    />
    <Path fill="#fff" fillRule="evenodd" d="M54 97V48h1v49h-1Z" clipRule="evenodd" />
    <Path fill="#fff" d="M87 54h.5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5H87v-8Z" />
    ...
    <Path
      ...
      clipRule="evenodd"
    />
    <Path fill="#fff" d="M213.5 78a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
    <Path
      fill="#000"
      fillRule="evenodd"
