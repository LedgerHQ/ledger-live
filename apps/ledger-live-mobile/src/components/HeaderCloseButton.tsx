 ...
 *
 * For more advanced configuration (for ex: a confirmation modal), use `HeaderCloseButtonAdvanced` defined below.
 */
export const HeaderCloseButton: React.FC<Props> = React.memo(
  ({ onPress, color }) => {
    const navigation = useNavigation<StackNavigationProp<ParamListBase>>();
    return (
      <Touchable
        event="HeaderCloseButtonAdvanced"
...
/**
 * Close button that should be used as the close button on the right of the react-navigation header when advanced configuration is needed.
 *
 * Enables a confirmation modal, and some legacy configuration.
 */
export const HeaderCloseButtonAdvanced: React.FC<AdvancedProps> = React.memo(
  ({
    color,
    preferDismiss = true,
    skipNavigation,
    ...
    return (
      <>
        <HeaderCloseButton onPress={onPress} color={color} />
        {withConfirmation && (
          <ConfirmationModal
