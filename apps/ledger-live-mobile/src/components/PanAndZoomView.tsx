...
const PanAndZoomView = ({ children }: { children: React.ReactNode }) => {
  ...
  const translateX = Animated.add(
    ...
    Platform.OS === "ios"
      ? panTranslateX
      : Animated.divide(panTranslateX, scale), // on android the scale of the outer view impacts the translation so we need to compensate, not on ios
  );
  ...
  const translateY = Animated.add(
    ...
    Platform.OS === "ios"
      ? panTranslateY
      : Animated.divide(panTranslateY, scale), // on android the scale of the outer view impacts the translation so we need to compensate, not on ios
  );
