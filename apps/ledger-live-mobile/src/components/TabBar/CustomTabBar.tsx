...
import { IconProps } from "@ledgerhq/native-ui/components/Icon/type";
...
export type Props = {
  ...
  descriptors: Record<
    ...
    {
      options: {
        tabBarIcon: React.ComponentType<IconProps>;
        tabBarAccessibilityLabel?: TouchableOpacityProps["accessibilityLabel"];
        tabBarTestID?: TouchableOpacityProps["testID"];
      };
    }
  >;
  navigation: any;
