 ...
 *
 * For more advanced configuration (for ex: a confirmation modal), use `NavigationHeaderCloseButtonAdvanced` defined below.
 */
export const NavigationHeaderCloseButton: React.FC<Props> = React.memo(
  ({ onPress, color }) => {
    ...
    return (
      <Touchable
        event="NavigationHeaderCloseButtonAdvanced"
