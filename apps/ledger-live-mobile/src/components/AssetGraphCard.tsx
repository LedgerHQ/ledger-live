...
export default function AssetGraphCard({
  ...
  const [hoveredItem, setHoverItem] = useState<Item | null | undefined>();
  ...
  return (
    <Card style={styles.root}>
      ...
      <Graph
        ...
        color={isAvailable ? graphColor : colors.grey} // $FlowFixMe
        data={history}
        onItemHover={setHoverItem} // $FlowFixMe
      ...
      <View style={styles.pillsContainer}>
        <Pills
          ...
          value={range}
          onChange={setTimeRange} // $FlowFixMe
...
function GraphCardHeader({
  ...
  counterValueUnit: Unit;
  to: Item;
  hoveredItem: Item | null | undefined;
  renderTitle?: RenderTitle;
  useCounterValue?: boolean;
  valueChange: ValueChange;
}) {
