...
/**
 * View component used by specific service permission denied error components
 *
 ...
 */
const ServicePermissionDeniedView: React.FC<Props> = ({
  title,
  TitleIcon,
  description,
  subTitle,
...
export default ServicePermissionDeniedView;
