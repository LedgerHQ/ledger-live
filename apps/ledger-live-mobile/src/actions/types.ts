...
export enum SettingsActionTypes {
  ...
  SETTINGS_SET_PERSONNALIZED_RECOMMENDATIONS = "SETTINGS_SET_PERSONNALIZED_RECOMMENDATIONS",
...
export type SettingsSetPersonnalizedRecommendationsPayload =
  SettingsState["personnalizedRecommendationsEnabled"];
