...
export const updateProvidersAction = createAction<
  $PropertyType<UPDATE_PROVIDERS_TYPE, "payload">,
>("SWAP/UPDATE_PROVIDERS");

export const updateTransactionAction = createAction<
  $PropertyType<?Transaction, "payload">,
>("SWAP/UPDATE_TRANSACTION");
export const updateRateAction = createAction<
  $PropertyType<?Transaction, "exchangeRate">,
>("SWAP/UPDATE_RATE");
