...
import { ProtectActionTypes, ProtectDataPayload, ProtectStatusPayload } from "./types";

export const updateProtectData = createAction<ProtectDataPayload>(ProtectActionTypes.UPDATE_DATA);
