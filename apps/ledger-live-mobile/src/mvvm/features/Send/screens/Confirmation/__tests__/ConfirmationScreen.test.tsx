...
describe("ConfirmationScreen", () => {
  ...
  it("renders the error state with save logs/retry/close when the flow status is ERROR", () => {
    mockViewModel({ status: "ERROR", transactionError: new Error("broadcast failed") });
    render(<ConfirmationScreen />);
  ...
  it("renders nothing while the flow status is IDLE (transient, e.g. during retry)", () => {
    mockViewModel({ status: "IDLE" });
    render(<ConfirmationScreen />);
