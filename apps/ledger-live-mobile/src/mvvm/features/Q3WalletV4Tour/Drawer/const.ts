...
export type Q3WalletV4TourImageSource = {
  readonly light: number;
  readonly dark: number;
};

export type Q3WalletV4TourSlide = {
  readonly titleKey: string;
  readonly subTitleKey?: string;
  readonly imageSrc: Q3WalletV4TourImageSource;
};

export const Q3_WALLET_V4_TOUR_SLIDES: readonly Q3WalletV4TourSlide[] = [
  {
