...
const usePortfolioCryptosSectionViewModel = ({
  ...
  const {
    ...
    isLoading: defaultAssetsLoading,
    isError: defaultAssetsError,
  ...
  const isLoading = isEmptyState ? defaultAssetsLoading : false;
  const isError = isEmptyState ? defaultAssetsError : false;
