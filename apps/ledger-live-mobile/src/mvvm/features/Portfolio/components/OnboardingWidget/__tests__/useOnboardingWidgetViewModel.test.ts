...
describe("useOnboardingWidgetViewModel", () => {
  ...
  it.each([
    { completed: 0, total: 3, expectedArcStep: 1, expectedTotal: 4, expectedLabel: "1/4" },
    { completed: 1, total: 3, expectedArcStep: 2, expectedTotal: 4, expectedLabel: "2/4" },
    { completed: 2, total: 3, expectedArcStep: 3, expectedTotal: 4, expectedLabel: "3/4" },
    { completed: 3, total: 3, expectedArcStep: 4, expectedTotal: 4, expectedLabel: "4/4" },
    { completed: 0, total: 4, expectedArcStep: 1, expectedTotal: 5, expectedLabel: "1/5" },
  ])(
