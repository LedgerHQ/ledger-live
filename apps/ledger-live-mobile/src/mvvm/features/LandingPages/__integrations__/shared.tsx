...
export const classicCards: ContentCard[] = [
  ...
  },
  {
    ...
    openURLInWebView: true,
    isControl: false,
    extras: { categoryId: "nanox_accessories" },
    type: "Classic",
    image: "https://example.com/images/card4.jpg",
    title: "Ledger Nano X Case",
    cardDescription: "Protect your device.",
    domain: "shop.example.com",
    url: "https://shop.example.com/nanox-case",
  },
];
