  ...
  const result = render(
    <Stack.Navigator screenOptions={{ headerShown: false, animation: "none" }}>
      <Stack.Screen
        ...
        initialParams={selectForPay ? { title, selectForPay } : { title }}
      />
...
describe("Contacts selectForPay", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it("should open contact detail when selectForPay is off", async () => {
    const { user, yana } = renderContactsSelectForPay({ selectForPay: false, title: "Contacts" });
