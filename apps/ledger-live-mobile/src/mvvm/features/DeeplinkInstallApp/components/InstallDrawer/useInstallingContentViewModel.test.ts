...
const mockUseAppDeviceAction = useAppDeviceAction as jest.MockedFunction<typeof useAppDeviceAction>;
...
describe("useInstallingContentViewModel", () => {
  ...
  describe("onSuccess callback", () => {
    it("should call onSuccess when opened becomes true", () => {
      ...
      renderHook(() => useInstallingContentViewModel({ ...defaultParams, onSuccess }));
  ...
  describe("onError callback", () => {
    it("should call onError when an error occurs", () => {
      ...
      renderHook(() => useInstallingContentViewModel({ ...defaultParams, onError }));
