...
const ScannedAccountsSection = ({
  ...
  /**
   * unlike legacy implementation here (apps/ledger-live-mobile/src/screens/AddAccounts/03-Accounts.tsx) deleting oxlint-disable-next-line react-hooks/exhaustive-deps provoked a maximum update depth error
