...
import { useHubDrawerPresentation } from "./useHubDrawerPresentation";
...
export function usePostOnboardingHubDrawerViewModel() {
  ...
  useHubDrawerPresentation(bottomSheetRef, isPostOnboardingHubDrawerOpen);
  ...
  }, [bottomSheetRef, closePostOnboardingHubDrawer, completePostOnboarding]);
