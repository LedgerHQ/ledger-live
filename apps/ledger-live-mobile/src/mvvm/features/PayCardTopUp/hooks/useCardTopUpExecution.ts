  ...
  const execute = useCallback(
    async (amount: BigNumber): Promise<string | undefined> => {
      ...
      try {
        ...
        if (fromCurrency.id !== destination.ledgerId) {
