...
function ClaimRewardsAmount({ navigation, route }: Props) {
  ...
  if (!isCosmosAccount(account)) {
    throw new Error("account and cosmos transaction required");
  }
  ...
  const onNext = useCallback(() => {
    navigation.navigate(ScreenName.OsmosisClaimRewardsSelectDevice, {
      ...route.params,
  ...
  const name =
    ...
    "";
  const mode = (transaction as OsmosisTransaction).mode || "";
    ...
    <SafeAreaView style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.footer, { backgroundColor: colors.background }]}>
        ...
        <Button
          ...
          event="Osmosis ClaimRewardsAmountContinueBtn"
          onPress={onNext}
