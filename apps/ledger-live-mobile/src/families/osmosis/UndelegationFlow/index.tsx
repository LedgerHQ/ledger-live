...
function UndelegationFlow() {
  ...
  return (
    ...
    >
      <Stack.Screen
        name={ScreenName.OsmosisUndelegationAmount}
      ...
      />
      <Stack.Screen
        name={ScreenName.OsmosisUndelegationSelectDevice}
      ...
      />
      <Stack.Screen
        name={ScreenName.OsmosisUndelegationConnectDevice}
      ...
      />
      <Stack.Screen
        name={ScreenName.OsmosisUndelegationValidationError}
      ...
      />
      <Stack.Screen
        name={ScreenName.OsmosisUndelegationValidationSuccess}
...
const Stack = createStackNavigator<OsmosisUndelegationFlowParamList>();
