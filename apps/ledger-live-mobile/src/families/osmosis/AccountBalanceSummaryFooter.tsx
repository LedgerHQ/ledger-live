...
function useInfo(): { [key in InfoName]: ModalInfo[] } {
  ...
  invariant(OsmosisIcon, "Icon is expected");

  return {
    available: [
      {
        Icon: () => <OsmosisIcon color={currency.color} size={18} />,
        title: t("osmosis.info.available.title"),
    ...
    delegated: [
      {
        ...
        description: t("osmosis.info.delegated.description"),
      },
    ],
    undelegating: [
      {
        title: t("cosmos.info.undelegating.title"),
        description: t("osmosis.info.undelegating.description"),
      },
    ],
  };
}
