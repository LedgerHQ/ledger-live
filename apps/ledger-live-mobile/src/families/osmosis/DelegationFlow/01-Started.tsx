...
export default function DelegationStarted({ navigation, route }: Props) {
  ...
  const howDelegationWorks = useCallback(() => {
    Linking.openURL(urls.osmosisStakingRewards);
  }, []);
    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <Text fontWeight="semiBold" style={styles.description}>
          <Trans i18nKey="osmosis.delegation.flow.steps.starter.description" />
        </Text>
        <BulletList
          Bullet={BulletGreenCheck}
          list={[
            <Trans i18nKey="cosmos.delegation.flow.steps.starter.steps.0" />,
            <Trans i18nKey="osmosis.delegation.flow.steps.starter.steps.1" />,
