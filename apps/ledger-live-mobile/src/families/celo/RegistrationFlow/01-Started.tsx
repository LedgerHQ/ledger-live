...
type RouteParams = {
  accountId: string;
  // any other params can be passed here, for example:
...
export default function RegistrationStarted({ navigation, route }: Props) {
  const { colors } = useTheme();
    
  // You can get the account with this hook
  ...
  return (
    ...
    <Text> Registration Started. Account ID is: {account?.id} </Text>
