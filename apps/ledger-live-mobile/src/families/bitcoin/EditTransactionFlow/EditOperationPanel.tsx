...
const EditOperationPanelComponent = ({
  ...
  const onLinkPress = useCallback(() => {
    ...
    if (account && isBitcoinCurrencySupported) {
  ...
  }, [account, parentAccount, operation, navigation, onPress, isBitcoinCurrencySupported]);

  if (!isEditBtcTxEnabled || !isBitcoinCurrencySupported) {
    return null;
  }
