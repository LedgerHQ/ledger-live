...
describe("Aleo bond flow (integration)", () => {
  ...
  describe("SelectValidator", () => {
    ...
    it("shows the bonded validator right away instead of waiting on the first load", async () => {
      mockUseAleoValidators.mockReturnValue({
        validators: [],
        loading: true,
        error: null,
  ...
  describe("Amount", () => {
    ...
    it("warns and disables the max switch when the public balance is below the minimum", async () => {
