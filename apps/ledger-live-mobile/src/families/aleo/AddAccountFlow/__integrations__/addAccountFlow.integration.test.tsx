...
const mockViewKeyProgressSubscription = async (
  ...
  let viewKeys: Record<string, string | null> = {};

  for (const [index, step] of steps.entries()) {
    // Keep null entries: live-common records rejected accounts as null, not omitted.
    // Spread into a fresh object each step so reference-based memoization
    // sees a change, matching what the real getViewKeyExec emits.
    viewKeys = { ...viewKeys, [step.accountId]: step.viewKey };
