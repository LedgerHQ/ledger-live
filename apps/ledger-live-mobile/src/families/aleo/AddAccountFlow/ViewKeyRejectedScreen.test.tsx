...
const mockNavigation = {
  getParent: jest.fn(() => ({ goBack: mockGoBack })),
};
...
describe("ViewKeyRejectedScreen", () => {
  ...
  it("renders the title with the currency name interpolated", () => {
    renderScreen();
    expect(
      screen.getByText('aleo.addAccount.warnings.noAccountsAddedWarning.title:{"currency":"Aleo"}'),
    ).toBeTruthy();
  });
  ...
  it("renders the description", () => {
    renderScreen();
    expect(
      screen.getByText("aleo.addAccount.warnings.noAccountsAddedWarning.description"),
    ).toBeTruthy();
  });
  ...
  describe("close button behaviour", () => {
    ...
    it("calls navigation.getParent().goBack() when onCloseNavigation is not provided", () => {
      renderScreen();
