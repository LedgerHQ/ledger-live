...
describe("Staking section", () => {
  ...
  it("opens the unbond flow from the manage drawer", async () => {
    mockGetValidators.mockResolvedValue([makeValidator()]);
  ...
  it("blocks unbonding while an unbond is in flight", async () => {
    mockGetValidators.mockResolvedValue([makeValidator()]);
    const account = makeAccount({
      pendingOperations: [pendingOperation("UNBOND")],
      aleoResources: {
  ...
  it("blocks claiming while an unbond is in flight", async () => {
    const account = makeAccount({
      blockHeight: 10_000,
      pendingOperations: [pendingOperation("UNBOND")],
      aleoResources: {
