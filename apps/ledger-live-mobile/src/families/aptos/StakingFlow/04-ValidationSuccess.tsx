...
type Props = BaseComposite<
  StackNavigatorProps<AptosStakingFlowParamList, ScreenName.AptosStakingValidationSuccess>
>;
  ...
  return (
    ...
    >
      ...
      <ValidateSuccess
        ...
        title={<Trans i18nKey="aptos.staking.flow.steps.verification.success.title" />}
