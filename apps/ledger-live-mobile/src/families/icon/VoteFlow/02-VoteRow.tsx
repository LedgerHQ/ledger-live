...
import {
  MedalMedium, PenMedium, TrophyMedium
...
const IconVoteRow = ({
  ...
  const { address, value, isPR, rank, validator } = vote;
  ...
  const removeVote = useCallback(
    () => onRemove({ address, value }),
    [address, value, onRemove],
  );
    ...
    >
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => onEdit({ address, value }, name || address || '')}
        >
...
export default memo<VoteRowProps>(IconVoteRow);
