...
type NavigatorProps = CompositeScreenProps<
  StackNavigatorProps<IconUnfreezeFlowParamList, ScreenName.IconUnfreezeAmount>,
...
export default function IconFreezeAmount({ navigation, route }: NavigatorProps) {
  ...
  const { votingPower: power, totalDelegated: deligated } = iconResources;

  const votingPower = BigNumber(power);
  const totalDelegated = BigNumber(deligated);
  ...
  const onContinue = useCallback(() => {
    navigation.navigate(ScreenName.IconUnfreezeSelectDevice, {
              ...
              <View style={styles.bottomWrapper}>
                <View style={styles.available}>
                  <Text variant={"paragraph"} mr={3}>
                    <Trans i18nKey="icon.unfreeze.steps.amount.totalStaked" />
                  </Text>
                  <Text variant={"paragraph"} fontWeight={"semiBold"}>
                    <CurrencyUnitValue
                      ...
                      value={getDecimalPart(
                        votingPower.plus(totalDelegated),
                ...
                <View style={styles.available}>
                  <Text variant={"paragraph"} mr={3}>
                    <Trans i18nKey="icon.unfreeze.steps.amount.voted" />
                  </Text>
                  <Text variant={"paragraph"} fontWeight={"semiBold"}>
                    <CurrencyUnitValue
                      showCode
                ...
                </View><View style={styles.available}>
                  <Text variant={"paragraph"} mr={3}>
                    <Trans i18nKey="icon.unfreeze.steps.amount.amountToUnstake" />
                  </Text>
                  <Text variant={"paragraph"} fontWeight={"semiBold"}>
                    <CurrencyUnitValue
                      showCode
