...
describe("EVM EditOperationPanel", () => {
  ...
  it("returns null when currency is not supported", () => {
  ...
  it("navigates to evm method selection when CTA is pressed", async () => {
    mockedUseEditTxFeatureFlag.mockReturnValue({
      isEditTxEnabled: true,
    ...
    expect(navigate).toHaveBeenCalledWith(NavigatorName.EvmEditTransaction, {
