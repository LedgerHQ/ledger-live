...
export default function DelegationEndDate({ navigation, route }: Props) {
  ...
  const showMode = (selectedMode: string) => {
    setShow(true);
              ...
              <View style={styles.wrapper}>
                <View style={styles.datePickers}>
                  <Button
                    ...
                    type="secondary"
                    title={<Trans i18nKey={"avalanchepchain.delegation.flow.steps.endDate.selectEndDate"} />}
                  />
                  <Button
                    onPress={showTimepicker}
                    type="secondary"
                    title={<Trans i18nKey={"avalanchepchain.delegation.flow.steps.endDate.selectEndTime"} />}
                  />
                  {show && (
                    <DateTimePicker
