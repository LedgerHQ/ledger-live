...
function StakingAmount({ navigation, route }: Props) {
  ...
  invariant(
    account && account.suiResources && route.params.transaction,
          ...
          <View style={styles.container}>
            <View style={styles.amountWrapper}>
              <AmountInput
                ...
                error={error}
                warning={warning}
                testID="sui-delegation-amount-input"
              />
              <LText
            ...
            >
              ...
              {remaining.isZero() && (
                <View style={styles.labelContainer}>
                  ...
                  <LText style={[styles.assetsRemaining]} color={colors.success.c50}>
                    <Trans i18nKey={`sui.staking.flow.steps.amount.allAssetsUsed`} />
                  </LText>
                </View>
              )}
              {remaining.gt(0) && !error && (
                <View style={styles.labelContainer}>
                  <LText style={styles.assetsRemaining}>
                    <Trans
                      i18nKey="sui.staking.flow.steps.amount.assetsRemaining"
                      values={{
              ...
              <Button
                ...
                event="SuiStakingAmountContinueBtn"
                onPress={onNext}
                title={<Trans i18nKey="sui.staking.flow.steps.amount.cta" />}
                type="primary"
                testID="sui-delegation-amount-continue"
              />
            </View>
          </View>
        </TouchableWithoutFeedback>
