...
type Props = StackNavigatorProps<SendFundsNavigatorStackParamList, ScreenName.CantonEditMemo>;

function CantonEditMemo({ navigation, route }: Props) {
...
export { CantonEditMemo as component, options };
