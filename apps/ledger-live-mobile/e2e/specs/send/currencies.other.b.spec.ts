...
import { sendCurrencyIdsOtherB } from "./sendCurrencyCases";
import { runSendCurrencyHalfBalanceFlow } from "./sendCurrencyHalfBalanceFlow";

$TmsLink("B2CQA-1823");
describe("Send flow (Polkadot and Cosmos) — set B", () => {
  ...
  beforeAll(async () => {
    await app.init({
      ...
      testedCurrencies: sendCurrencyIdsOtherB,
    });
