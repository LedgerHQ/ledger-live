...
import { sendCurrencyIdsUtxoEvmA } from "./sendCurrencyCases";
import { runSendCurrencyHalfBalanceFlow } from "./sendCurrencyHalfBalanceFlow";

$TmsLink("B2CQA-1823");
describe("Send flow (UTXO and EVM currencies) — set A", () => {
  ...
  beforeAll(async () => {
    await app.init({
      ...
      testedCurrencies: sendCurrencyIdsUtxoEvmA,
    });
  ...
  it.each(sendCurrencyIdsUtxoEvmA)(
