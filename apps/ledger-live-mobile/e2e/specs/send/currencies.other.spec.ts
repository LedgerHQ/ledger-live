...
import { sendCurrencyIdsOther } from "./sendCurrencyCases";
import { runSendCurrencyHalfBalanceFlow } from "./sendCurrencyHalfBalanceFlow";

$TmsLink("B2CQA-1823");
describe("Send flow (Polkadot and Cosmos)", () => {
  ...
  beforeAll(async () => {
    await app.init({
      ...
      testedCurrencies: sendCurrencyIdsOther,
    });
