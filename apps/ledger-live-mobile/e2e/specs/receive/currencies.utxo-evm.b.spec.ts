...
import { receiveCurrencyCasesUtxoEvmB } from "./receiveCurrencyCases";
import { runReceiveCurrencyScanningFlow } from "./receiveCurrencyScanningFlow";

$TmsLink("B2CQA-651");
$TmsLink("B2CQA-1854");
describe("Receive different currency (UTXO and EVM) — set B", () => {
  ...
  it.each(receiveCurrencyCasesUtxoEvmB)(
