export default {
  ...
  infinityPassCenterDark: require("./infinityPassDark/infinityPassCenter.mp4"),
  infinityPassCenterLight: require("./infinityPassLight/infinityPassCenter.mp4"),
  infinityPassLoopDark: require("./infinityPassDark/infinityPassLoop.mp4"),
  infinityPassLoopLight: require("./infinityPassLight/infinityPassLoop.mp4"),
