...
const saveObjectToStorage = (key: string, data: unknown) => {
  localStorage.setItem(key, JSON.stringify(data));
};

const loadObjectFromStorage = (key: string) => JSON.parse(localStorage.getItem(key) || "{}");
...
function LiveEnvEditor() {
  const [state, setState] = useState<Object>(loadEnv);
