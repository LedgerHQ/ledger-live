...
/**
 * Maps a Solana CLI intent onto the generic transaction, through the family's own constructors so
 * the CLI cannot drift from the apps. `amount` is applied later by `buildValidatedTx`.
 */
