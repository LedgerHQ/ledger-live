...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  ...
  'quote': {
      ...
      options: {
        'from': { type: 'z.string.min', required: true, hasDefault: false, description: 'Source currency ID', short: 'f', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1210,"end":1211,"loc":{"start":{"line":38,"column":32,"index":1210},"end":{"line":38,"column":33,"index":1211}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Source currency is required"}]}, validator: '(val) => true' },
        'to': { type: 'z.string.min', required: true, hasDefault: false, description: 'Destination currency ID', short: 't', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1344,"end":1345,"loc":{"start":{"line":42,"column":30,"index":1344},"end":{"line":42,"column":31,"index":1345}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Destination currency is required"}]}, validator: '(val) => true' },
        'from-account': { type: 'z.string.min.optional', required: false, hasDefault: false, description: 'Account descriptor for the asset you send (same format as account discover / balances / operations). Pairs with --to-account; resolves send address via sync (see receive).', min: 1, minLength: 1, schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'to-account': { type: 'z.string.min.optional', required: false, hasDefault: false, description: 'Account descriptor for the asset you receive. Pairs with --from-account; resolves receive address via sync.', min: 1, minLength: 1, schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'amount': { type: 'z.string.min', required: true, hasDefault: false, description: 'Amount to swap in source currency', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1964,"end":1965,"loc":{"start":{"line":54,"column":34,"index":1964},"end":{"line":54,"column":35,"index":1965}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Amount is required"}]}, validator: '(val) => true' },
