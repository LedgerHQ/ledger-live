...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  ...
  'execute': {
      ...
      options: {
        'provider': { type: 'z.string.min', required: true, hasDefault: false, description: 'Swap provider name, e.g. changelly', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1011,"end":1012,"loc":{"start":{"line":24,"column":36,"index":1011},"end":{"line":24,"column":37,"index":1012}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Provider is required (--provider <name>)"}]}, validator: '(val) => true' },
        'amount': { type: 'z.string.min', required: true, hasDefault: false, description: 'Swap source amount in human units', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1160,"end":1161,"loc":{"start":{"line":27,"column":34,"index":1160},"end":{"line":27,"column":35,"index":1161}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Amount is required (--amount <value>)"}]}, validator: '(val) => true' },
        'to-account': { type: 'z.string.optional', required: false, hasDefault: false, description: 'Destination account descriptor or session label (required for full pipeline)', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        'account': { type: 'z.string.min.optional', required: false, hasDefault: false, description: 'Account descriptor or session label (e.g. ethereum-1). Can also be the first positional arg.', short: 'a', min: 1, minLength: 1, schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
        ...
        'dry-run': { type: 'z.boolean.default', required: true, hasDefault: true, default: false, description: 'Run through exchange preparation but do not sign or broadcast', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":1673,"end":1678,"loc":{"start":{"line":37,"column":42,"index":1673},"end":{"line":37,"column":47,"index":1678}},"value":false}}]}, validator: '(val) => true' },
        'output': { type: 'OutputFormatSchema.optional', required: false, hasDefault: false, description: 'Output format: human or json (default: human)', schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' }
      },
