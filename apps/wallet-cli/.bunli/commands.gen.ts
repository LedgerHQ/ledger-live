...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  ...
  'execute': {
      ...
      options: {
        'provider': { type: 'z.string.min', required: true, hasDefault: false, description: 'Swap provider name, e.g. changelly', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1000,"end":1001,"loc":{"start":{"line":26,"column":36,"index":1000},"end":{"line":26,"column":37,"index":1001}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Provider is required (--provider <name>)"}]}, validator: '(val) => true' },
        'amount': { type: 'z.string.min', required: true, hasDefault: false, description: 'Swap source amount in human units', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1149,"end":1150,"loc":{"start":{"line":29,"column":34,"index":1149},"end":{"line":29,"column":35,"index":1150}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Amount is required (--amount <value>)"}]}, validator: '(val) => true' },
        'to-account': { type: 'z.string.min', required: true, hasDefault: false, description: 'Destination account descriptor or session label (required for full pipeline)', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1300,"end":1301,"loc":{"start":{"line":32,"column":40,"index":1300},"end":{"line":32,"column":41,"index":1301}},"extra":{"rawValue":1,"raw":"1"},"value":1}}]}, validator: '(val) => true' },
        'account': { type: 'z.string.min.optional', required: false, hasDefault: false, description: 'Account descriptor or session label (e.g. ethereum-1). Can also be the first positional arg.', short: 'a', min: 1, minLength: 1, schema: {"type":"zod","method":"optional","args":[]}, validator: '(val) => true' },
