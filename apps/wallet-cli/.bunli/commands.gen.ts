...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  ...
  'quote': {
      ...
      options: {
        'from': { type: 'z.string.min', required: true, hasDefault: false, description: 'Source currency ID', short: 'f', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1205,"end":1206,"loc":{"start":{"line":38,"column":32,"index":1205},"end":{"line":38,"column":33,"index":1206}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Source currency is required"}]}, validator: '(val) => true' },
        'to': { type: 'z.string.min', required: true, hasDefault: false, description: 'Destination currency ID', short: 't', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1339,"end":1340,"loc":{"start":{"line":42,"column":30,"index":1339},"end":{"line":42,"column":31,"index":1340}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Destination currency is required"}]}, validator: '(val) => true' },
        'from-account': { type: 'z.string.min', required: true, hasDefault: false, description: 'Source account ID is required', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1495,"end":1496,"loc":{"start":{"line":46,"column":42,"index":1495},"end":{"line":46,"column":43,"index":1496}},"extra":{"rawValue":1,"raw":"1"},"value":1}}]}, validator: '(val) => true' },
        'to-account': { type: 'z.string.min', required: true, hasDefault: false, description: 'Destination account ID is required', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1601,"end":1602,"loc":{"start":{"line":49,"column":40,"index":1601},"end":{"line":49,"column":41,"index":1602}},"extra":{"rawValue":1,"raw":"1"},"value":1}}]}, validator: '(val) => true' },
        'amount': { type: 'z.string.min', required: true, hasDefault: false, description: 'Amount to swap in source currency', min: 1, minLength: 1, schema: {"type":"zod","method":"min","args":[{"type":"unknown","raw":{"type":"NumericLiteral","start":1706,"end":1707,"loc":{"start":{"line":52,"column":34,"index":1706},"end":{"line":52,"column":35,"index":1707}},"extra":{"rawValue":1,"raw":"1"},"value":1}},{"type":"literal","value":"Amount is required"}]}, validator: '(val) => true' },
        'format': { type: 'OutputFormatSchema.default', required: true, hasDefault: true, default: "human", description: 'Output format', schema: {"type":"zod","method":"default","args":[{"type":"literal","value":"human"}]}, validator: '(val) => true' }
      },
