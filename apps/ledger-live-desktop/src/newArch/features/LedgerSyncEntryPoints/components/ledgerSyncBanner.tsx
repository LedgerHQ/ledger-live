...
type LedgerSyncBannerVariant = "illustration" | "neutralIcon";

export function LedgerSyncBanner({
  variant = "illustration",
  onPress,
}: {
  variant?: LedgerSyncBannerVariant;
  onPress: () => void;
}) {
    ...
    <BannerContainer>
      ...
      <ContentContainer>
        <Text variant="h4Inter" fontSize={16} fontWeight="600" color="neutral.c100">
          {variant === "neutralIcon" ? t("walletSync.title") : t("walletSync.banner.title")}
        </Text>
