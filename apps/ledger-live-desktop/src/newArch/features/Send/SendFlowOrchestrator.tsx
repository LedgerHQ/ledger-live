...
import {
  ...
  createStepRegistry as createGenericStepRegistry,
...
import type { SendFlowStep, SendFlowInitParams, SendFlowBusinessContext } from "./types";

type SendFlowStepRegistry = StepRegistry<SendFlowStep>;
type SendFlowWizardContext = FlowWizardContextValue<SendFlowStep, SendFlowBusinessContext>;
...
function SendFlowProviderWrapper({
  value,
  children,
}: {
...
export function SendFlowOrchestrator({
  ...
  return (
    <FlowWizardOrchestrator<SendFlowStep, SendFlowBusinessContext>
...
export function createStepRegistry(registry: SendFlowStepRegistry): SendFlowStepRegistry {
  return createGenericStepRegistry(registry);
}
