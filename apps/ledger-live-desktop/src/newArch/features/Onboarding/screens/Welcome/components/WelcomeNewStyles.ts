...
export const ContentOverlay = styled(Flex).attrs({
  flexDirection: "column",
  height: "100%",
  width: "100%",
  position: "relative",
...
export const TopSection = styled(Flex).attrs({
  flexDirection: "column",
  rowGap: "16px",
  alignItems: "center",
  p: "40px",
...
export const ProgressBarsContainer = styled(Flex).attrs({
  flexDirection: "row",
  columnGap: "4px",
  width: "300px",
})``;
...
export const BottomSection = styled(Flex).attrs({
  flexDirection: "column",
  alignItems: "center",
  p: "40px",
  rowGap: "16px",
