...
function createMockStore(overrides?: { rumId?: string; isDummy?: boolean }) {
...
describe("datadog renderer", () => {
  ...
  describe("initDatadog success and when initialized", () => {
    ...
    it("when already initialized should return true without calling init again", async () => {
      const store = createMockStore();
