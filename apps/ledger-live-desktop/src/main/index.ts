...
async function installExtensions() {
  ...
  // Note: This is now called asynchronously to not block startup
  try {
    ...
    console.log("Dev extensions installed successfully");
  } catch (error) {
    console.error("Failed to install dev extensions:", error);
  }
}
