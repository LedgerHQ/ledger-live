  ...
  if (optimisticOperation) {
    return (
      <Container>
        ...
        <SuccessDisplay
          title={
            <Trans i18nKey="staking.delegation.flow.steps.confirmation.success.title" />
          }
          description={multiline(
            t("staking.delegation.flow.steps.confirmation.success.text"),
          )}
        />
      </Container>
    );
      ...
      <Container shouldSpace={signed}>
        ...
        {signed ? (
          <BroadcastErrorDisclaimer
            title={
              <Trans i18nKey="staking.delegation.flow.steps.confirmation.broadcastError" />
            }
          />
        ) : null}
  ...
  if (concernedOperation) {
    footerSecondaryAction = (
      <Button
        primary
        ml={2}
        event="Delegation Step 3 View OpD Clicked"
        onClick={() => {
          onClose();
      ...
      >
        <Trans i18nKey="staking.delegation.flow.steps.confirmation.success.cta" />
      </Button>
    );
  } else if (error) {
