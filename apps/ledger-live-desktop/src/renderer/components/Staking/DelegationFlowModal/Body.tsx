...
const steps: Array<St> = [
  {
    id: "validator",
    label: <Trans i18nKey="staking.delegation.flow.steps.validator.title" />,
  ...
  {
    id: "amount",
    label: <Trans i18nKey="staking.delegation.flow.steps.amount.title" />,
  ...
  {
    id: "connectDevice",
    label: <Trans i18nKey="staking.delegation.flow.steps.connectDevice.title" />,
    component: GenericStepConnectDevice as unknown as React.ComponentType<StepProps>,
    onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
  },
  {
    id: "confirmation",
    label: <Trans i18nKey="staking.delegation.flow.steps.confirmation.title" />,
...
const Body = ({ onClose, t, stepId, device, openModal, onChangeStepId, params }: Props) => {
  ...
  const {
    ...
    invariant(isStakingAccount(account), "account with staking resources required");
  ...
  const stepperProps = {
    title: t("staking.delegation.flow.title"),
    device,
    account,
    parentAccount,
    transaction,
