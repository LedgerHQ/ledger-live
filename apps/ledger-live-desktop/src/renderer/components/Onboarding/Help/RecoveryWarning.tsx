...
export default function RecoveryWarning() {
  ...
  return (
    <ScrollArea isInsideDrawer>
      <PinHelpContainer>
        <Text mt={4} textAlign="center" color="legacyWarning">
          <TriangleWarning size={56} />
        </Text>

        <Text color="neutral.c100" ff="Inter|SemiBold" fontSize="22px" lineHeight="26.63px">
          {t("onboarding.screens.tutorial.screens.existingRecoveryPhrase.warning.title")}
        </Text>
        <Text mt="8px" color="neutral.c100" ff="Inter|Regular" fontSize="14px" lineHeight="19.5px">
          {t("onboarding.screens.tutorial.screens.existingRecoveryPhrase.warning.desc")}
        </Text>
        <FakeLink onClick={onClickLink}>
          <Text mt="8px" color="primary.c80" ff="Inter|Regular" fontSize="14px" lineHeight="19.5px">
