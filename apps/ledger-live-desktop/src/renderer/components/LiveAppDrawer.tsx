...
import { createAction, Result as StartExchangeResult } from "@ledgerhq/live-common/hw/actions/startExchange";
...
import CompleteExchange, {
  Data as CompleteExchangeData, isCompleteExchangeData,
