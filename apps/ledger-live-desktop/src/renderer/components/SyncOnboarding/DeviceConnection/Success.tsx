...
const SyncOnboardingDeviceConnectionSuccess = ({ device }: SyncOnboardingDeviceConnectionSuccessProps) => {
  ...
  return (
    <Flex height= "100%" width="100%" justifyContent= "center" alignItems= "center" flexDirection= "column">
      ...
      <Text variant="h3" fontSize="28px" color="neutral.c100"> ✅ {t("syncOnboarding.connection.success.title", { deviceName })}</Text>
    </Flex>
  );
};
