...
const getPtxAttributes = () => {
  ...
  const ptxSwapExodusProviderFlag = analyticsFeatureFlagMethod("ptxSwapExodusProvider");
  ...
  const ptxSwapExodusProviderEnabled: boolean = !!ptxSwapExodusProviderFlag?.enabled;
  return {
    isBatch1Enabled,
    isBatch2Enabled,
    isBatch3Enabled,
