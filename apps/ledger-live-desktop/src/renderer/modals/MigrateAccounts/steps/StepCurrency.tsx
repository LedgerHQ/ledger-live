...
import { findAccountMigration, migrateAccounts } from "@ledgerhq/live-common/account/index";
    ...
    this.scanSubscription = getCurrencyBridge(currency)
      ...
      .pipe(
        ...
        map(({ account }) => {
          if (getEnv("MOCK") && account.id.startsWith("mock:0")) {
            ...
            return {
              ...account,
              id: account.id.replace("mock:0", "mock:1"),
            };
          }
          return account;
        }),
      ...
      .subscribe({
        next: scannedAccounts => {
          ...
          const migratedAccounts = migrateAccounts({
            scannedAccounts,
