...
export const getAccountBridge = (
  ...
  return {
    ...
    sync,
    receive,
    applyReconciliation: bridgeImpl.getAccountBridge(account, parentAccount).toResourcesRaw,
    toAccountRaw: bridgeImpl.getAccountBridge(account, parentAccount).toResourcesRaw,
    fromAccountRaw: bridgeImpl.getAccountBridge(account, parentAccount).toResourcesRaw,
    signOperation,
    broadcast,
