  ...
  if (optimisticOperation) {
    return (
      <Container>
        ...
        <SuccessDisplay
          title={<Trans i18nKey="hedera.stake.flow.steps.confirmation.success.title" />}
          description={multiline(t("hedera.stake.flow.steps.confirmation.success.text"))}
        />
      </Container>
    );
  }
      ...
      <Container shouldSpace={signed}>
        ...
        {signed ? (
          <BroadcastErrorDisclaimer
            title={<Trans i18nKey="hedera.stake.flow.steps.confirmation.broadcastError" />}
          />
        ) : null}
  ...
  return (
    <Box horizontal alignItems="right">
      ...
      {concernedOperation ? (
        ...
        >
          <Trans i18nKey="hedera.stake.flow.steps.confirmation.success.cta" />
        </Button>
      ) : error ? (
