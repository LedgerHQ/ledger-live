...
export default function StepDelegation({
  ...
  const selectPool = (stakePool: StakePool) => {
    ...
    onUpdateTransaction(tx => {
      const updatedTransaction = bridge.updateTransaction(transaction as CardanoTypes.Transaction, {
        mode: "delegate",
  ...
  const selectedPoolId = (transaction as CardanoTypes.Transaction).poolId;
  return (
    <Box flow={1}>
