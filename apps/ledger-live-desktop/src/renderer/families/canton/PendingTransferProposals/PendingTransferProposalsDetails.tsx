...
import { useTimeRemaining, formatDate } from "./utils";
  ...
  return (
    <Box flow={3} px={20} mt={20}>
      ...
      <OpDetailsSection>
        ...
        <OpDetailsData>{formatDate(proposal.expires_at_micros)}</OpDetailsData>
      </OpDetailsSection>
      ...
      {proposal.isExpired && (
        <OpDetailsSection>
          <OpDetailsTitle>{t("families.canton.pendingTransactions.status")}</OpDetailsTitle>
