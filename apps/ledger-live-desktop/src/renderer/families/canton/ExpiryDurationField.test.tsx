  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        "families.canton.expiryDuration.label": "Expiry Duration",
        "families.canton.expiryDuration.threeHours": "3 hours",
        "families.canton.expiryDuration.sixHours": "6 hours",
        "families.canton.expiryDuration.oneDay": "1 day",
        "families.canton.expiryDuration.oneWeek": "1 week",
        "families.canton.expiryDuration.oneMonth": "1 month",
      };
...
describe("ExpiryDurationField", () => {
  ...
  it("should map DurationEnum values correctly to seconds", () => {
    ...
    const testCases = [
      ...
      { enum: DurationEnum.ONE_MONTH, seconds: 30 * 24 * 60 * 60, label: "1 month" },
    ];
