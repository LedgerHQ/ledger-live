...
import StepNomination, { StepNominationFooter } from "./steps/StepNomination";
...
const Body = ({
  ...
  const stepperProps = {
    ...
    errorSteps,
    disabledSteps: [],
    hideBreadcrumb: !!error && ["castNominations"].includes(stepId),
    onRetry: handleRetry,
  ...
  return (
    <Stepper {...stepperProps}>
      ...
      <Track onUnmount event="CloseModalNomination" />
    </Stepper>
  );
};
