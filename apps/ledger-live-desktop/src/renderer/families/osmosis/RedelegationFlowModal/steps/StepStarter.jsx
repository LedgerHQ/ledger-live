...
import type { StepProps } from "../../../cosmos/RedelegationFlowModal/types";
    ...
    <Box flow={4}>
      ...
      <Box flow={1} alignItems="center">
        ...
        <Box mb={4}>
          ...
          >
            <Trans i18nKey="osmosis.redelegation.flow.steps.starter.description" />
          </Text>
        </Box>
        <Alert type="primary">
          <Trans i18nKey="osmosis.redelegation.flow.steps.starter.warning">
            <b></b>
          </Trans>
        </Alert>
      </Box>
  ...
  return (
    <>
      <LinkWithExternalIcon
        label={<Trans i18nKey="osmosis.redelegation.flow.steps.starter.howDelegationWorks" />}
