...
export default function StepValidators({
  ...
  return (
    <Container>
      ...
      <Box py={4}>
        <Label mb={5}>{t("osmosis.redelegation.flow.steps.validators.newDelegation")}</Label>
          ...
          <Box flex="1" horizontal alignItems="center" justifyContent="space-between">
            {selectedValidatorData ? (
              ...
              <Text ff="Inter|Medium">
                {t("osmosis.redelegation.flow.steps.validators.chooseValidator")}
              </Text>
            )}
      ...
      {selectedValidatorData && (
        <Box pb={4}>
          <AmountField
            ...
            label={t("osmosis.redelegation.flow.steps.validators.amountLabel")}
          />
        </Box>
      )}

      <Alert type="primary">
        <Trans i18nKey="osmosis.redelegation.flow.steps.validators.warning">
          <b></b>
        </Trans>
      </Alert>
    </Container>
