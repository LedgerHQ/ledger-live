...
import type { StepId, StepProps, St } from "../../cosmos/RedelegationFlowModal/types";
...
import StepDestinationValidators from "../../cosmos/RedelegationFlowModal/steps/StepDestinationValidators";
...
const steps: Array<St> = [
  {
    id: "validators",
    label: <Trans i18nKey="osmosis.redelegation.flow.steps.validators.title" />,
  ...
  {
    id: "connectDevice",
    label: <Trans i18nKey="osmosis.redelegation.flow.steps.device.title" />,
    component: GenericStepConnectDevice,
    onBack: ({ transitionTo }: StepProps) => transitionTo("castRedelegations"),
  },
  {
    id: "confirmation",
    label: <Trans i18nKey="osmosis.redelegation.flow.steps.confirmation.title" />,
  ...
  {
    id: "starter",
    label: <Trans i18nKey="osmosis.redelegation.flow.steps.starter.title" />,
...
const Body = ({
  ...
  const {
    ...
    invariant(account && account.cosmosResources, "Osmosis account with cosmos resources required");
  ...
  const stepperProps = {
    title: t("osmosis.redelegation.flow.title"),
    device,
    account,
    parentAccount,
    transaction,
