...
const steps: Array<St> = [
  {
    id: "validator",
    label: <Trans i18nKey="helium.delegation.flow.steps.validator.title" />,
  ...
  {
    id: "amount",
    label: <Trans i18nKey="helium.delegation.flow.steps.amount.title" />,
  ...
  {
    id: "connectDevice",
    label: <Trans i18nKey="helium.common.connectDevice.title" />,
    component: GenericStepConnectDevice,
    onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
  },
  {
    id: "confirmation",
    label: <Trans i18nKey="helium.common.confirmation.title" />,
...
const Body = ({
  ...
  const {
    ...
    invariant(account && account.heliumResources, "helium: account and helium resources required");
  ...
  const stepperProps = {
    title: t("helium.delegation.flow.title"),
    device,
    account,
    parentAccount,
    transaction,
