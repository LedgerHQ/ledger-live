...
import { AccountBridge, Transaction } from "@ledgerhq/live-common/types";
...
const Container: ThemedComponent<any> = styled(Box)`
    ...
    <Container flow={4}>
      <Alert type="primary" learnMoreUrl={urls.avalanche.learnMoreStakingParameters} mb={3}>
        <Trans
          ...
          values={{
            minEndDate: minEndDateText,
            maxEndDate: maxEndDateText,
          }}
        />
      </Alert>
