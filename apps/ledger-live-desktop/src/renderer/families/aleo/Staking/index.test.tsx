...
// Tippy renders its content lazily on hover, which jsdom makes unreliable. Keeping the content out
// of the DOM also keeps the text assertions below about what the section itself renders.
