...
const steps: Array<St> = [
  {
    id: "validator",
    label: <Trans i18nKey="sui.stake.flow.steps.validator.title" />,
    component: StepStake,
    noScroll: true,
  ...
  {
    id: "amount",
    label: <Trans i18nKey="sui.stake.flow.steps.amount.title" />,
  ...
  {
    id: "connectDevice",
    label: <Trans i18nKey="sui.stake.flow.steps.connectDevice.title" />,
    component: GenericStepConnectDevice,
    onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
  },
  {
    id: "confirmation",
    label: <Trans i18nKey="sui.stake.flow.steps.confirmation.title" />,
