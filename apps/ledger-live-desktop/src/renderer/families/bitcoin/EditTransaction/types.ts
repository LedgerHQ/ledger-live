import { EditType } from "@ledgerhq/coin-bitcoin/types/editTransaction";
import { Transaction, TransactionStatus } from "@ledgerhq/coin-bitcoin/types/index";
...
export type StepProps = {
  ...
  setEditType: (a: EditType | undefined) => void;
};
