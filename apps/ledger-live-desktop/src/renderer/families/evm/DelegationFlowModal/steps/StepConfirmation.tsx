  ...
  if (optimisticOperation) {
    return (
      <Container>
        ...
        <SuccessDisplay
          title={
            <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.confirmation.success.title" />
          }
          description={multiline(
            t("ethereum.evmStaking.delegation.flow.steps.confirmation.success.text"),
          )}
        />
      </Container>
    );
      ...
      <Container shouldSpace={signed}>
        ...
        {signed ? (
          <BroadcastErrorDisclaimer
            title={
              <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.confirmation.broadcastError" />
            }
          />
        ) : null}
...
export function StepConfirmationFooter({
  ...
  if (concernedOperation) {
    footerSecondaryAction = (
      ...
      >
        <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.confirmation.success.cta" />
      </Button>
    );
  } else if (error) {
