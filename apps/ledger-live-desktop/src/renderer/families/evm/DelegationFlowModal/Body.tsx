...
const steps: Array<St> = [
  {
    id: "validator",
    label: <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.validator.title" />,
  ...
  {
    id: "amount",
    label: <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.amount.title" />,
  ...
  {
    id: "connectDevice",
    label: <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.connectDevice.title" />,
    component: GenericStepConnectDevice as unknown as React.ComponentType<StepProps>,
    onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
  },
  {
    id: "confirmation",
    label: <Trans i18nKey="ethereum.evmStaking.delegation.flow.steps.confirmation.title" />,
...
const Body = ({ onClose, t, stepId, device, openModal, onChangeStepId, params }: Props) => {
  ...
  const stepperProps = {
    title: t("ethereum.evmStaking.delegation.flow.title"),
    device,
    account,
    parentAccount,
    transaction,
