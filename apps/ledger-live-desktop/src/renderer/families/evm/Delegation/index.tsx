  ...
  return (
    <>
          ...
          {hasDelegations || hasRewards ? (
            <>
              {hasDelegations ? (
                <ToolTip
                  content={
                    delegationEnabled ? null : <Trans i18nKey="cosmos.delegation.minSafeWarning" />
                  }
                >
                  <Button
              ...
              <ToolTip
                content={hasRewards ? null : <Trans i18nKey="cosmos.delegation.noRewards" />}
              >
                <Button
      ...
      {hasRedelegations ? (
        <TableContainer mb={6}>
          <TableHeader
            title={<Trans i18nKey="cosmos.redelegation.header" />}
