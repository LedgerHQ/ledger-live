      ...
      <Container shouldSpace={signed}>
        ...
        {signed ? (
          <BroadcastErrorDisclaimer
            title={t("aptos.restake.flow.steps.confirmation.broadcastError")}
          />
        ) : null}
    ...
    <Box horizontal alignItems="right">
      ...
      {concernedOperation ? (
        <Button
          primary
          ml={2}
          event="restake Aptos Flow Step 3 View OpD Clicked"
          onClick={onViewDetails}
        >
          {t("aptos.restake.flow.steps.confirmation.success.cta")}
        </Button>
      ) : error ? (
