...
const steps: Array<St> = [
  {
    id: "validator",
    label: <Trans i18nKey="aptos.stake.flow.steps.validator.title" />,
    component: StepStake,
    noScroll: true,
  ...
  {
    id: "amount",
    label: <Trans i18nKey="aptos.stake.flow.steps.amount.title" />,
  ...
  {
    id: "connectDevice",
    label: <Trans i18nKey="aptos.stake.flow.steps.connectDevice.title" />,
    component: GenericStepConnectDevice,
    onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
  },
  {
    id: "confirmation",
    label: <Trans i18nKey="aptos.stake.flow.steps.confirmation.title" />,
...
const Body = ({ t, stepId, device, onClose, openModal, onChangeStepId, params }: Props) => {
  ...
  const stepperProps = {
    title: t("aptos.stake.flow.title"),
    device,
    account,
    transaction,
    signed,
