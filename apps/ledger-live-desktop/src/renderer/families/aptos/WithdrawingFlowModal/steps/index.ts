...
export function useSteps(): St[] {
  ...
  return useMemo<St[]>(
    () => [
      {
        id: "amount",
        label: t("aptos.withdraw.flow.steps.amount.title"),
      ...
      {
        id: "device",
        label: t("aptos.withdraw.flow.steps.connectDevice.title"),
        component: GenericStepConnectDevice,
        onBack: ({ transitionTo }: StepProps) => transitionTo("amount"),
      },
      {
        id: "confirmation",
        label: t("aptos.withdraw.flow.steps.confirmation.title"),
