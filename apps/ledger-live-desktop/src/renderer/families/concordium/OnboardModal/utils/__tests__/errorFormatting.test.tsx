...
// Override only Trans so i18nKey renders as text, preserving initReactI18next
// and other exports needed by testSetup and i18n/init at module load time.
jest.mock("react-i18next", () => ({
  ...jest.requireActual("react-i18next"),
  Trans: ({ i18nKey }: { i18nKey: string }) => <span>{i18nKey}</span>,
}));

// Spread the real axios so network.ts can use axios.interceptors at module load time,
// while overriding isAxiosError for predictable test behaviour.
jest.mock("axios", () => ({
