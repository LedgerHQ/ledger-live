...
import { CryptoCurrency, TokenCurrency } from "@ledgerhq/live-common/lib/types/currencies";
      ...
      <RowContainer onClick={openAddAccounts} id="add-account">
        <RowInnerContainer>
          <Box horizontal alignItems="center">
            ...
            <Text ff="Inter|SemiBold" color="inherit" fontSize="13px" style={{ marginLeft: 12 }}>
              {"Add account"}
            </Text>
          </Box>
        </RowInnerContainer>
