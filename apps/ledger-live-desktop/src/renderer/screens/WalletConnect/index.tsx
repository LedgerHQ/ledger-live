...
`;
const InnerContainer: ThemedComponent<any> = styled(Box)`
  position: absolute;
  top: 105px;
  left: 155px;
  right: 155px;
  ...
  padding: 24px;
`;
const LogoContainer: ThemedComponent<any> = styled.div`
  width: 94px;
  height: 94px;
  border-radius: 94px;
  ...
  position: relative;
`;
const CompanyLogoContainer: ThemedComponent<any> = styled.div`
  width: 98px;
  height: 24px;
  margin: 0 auto;
  margin-top: 41px;
`;
const ConnexionStatusContainer: ThemedComponent<any> = styled.div`
  width: 34px;
  height: 34px;
  border-radius: 34px;
  ...
  font-size: 19px;
`;
const AccountContainer: ThemedComponent<any> = styled(Box)`
  width: 100%;
  border: solid 1px ${p => p.theme.colors.palette.divider};
  border-radius: 4px;
`;
const Logo: ThemedComponent<any> = styled.img`
  width: 100%;
  height: 100%;
  object-fit: contain;
`;
const InfoBoxContainer: ThemedComponent<any> = styled.div`
  width: 100%;
  margin-bottom: 20px;
`;
const WalletConnect = () => {
  ...
  const account = useSelector(s =>
    accountSelector(s, {
      accountId: wcContext.session.accountId,
    }),
  );
  return (
    <Container>
