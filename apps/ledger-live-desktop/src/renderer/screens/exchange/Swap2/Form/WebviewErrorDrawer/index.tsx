...
export default function WebviewErrorDrawer(error?: Error) {
  ...
  const errorMessage = get(error, "swap.swap.error", "").toLowerCase();

  // keep backwards compatibility for versions that don't use combinedSwap
  // to remove after fully migrating to combinedSwap
