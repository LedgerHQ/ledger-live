...
const LendingTermsImg = styled.img.attrs(() => ({
  src: LendingTermsIllu,
}))`
  width: 315px;
  height: auto;
  ${p => (p.overlay ? `filter: brightness(0.8) grayscale(0.2);` : "")}
`;
const LendingTermsImg1 = styled.img.attrs(() => ({
  src: LendingTermsIllu1,
}))`
  width: 60px;
  height: auto;
  position: absolute;
...
`;
const LendingTermsImg2 = styled.img.attrs(() => ({
  src: LendingTermsIllu2,
}))`
  width: 55px;
  height: auto;
  position: absolute;
...
`;
const LendingTermsImg3 = styled.img.attrs(() => ({
  src: LendingTermsIllu3,
}))`
  width: 45px;
  height: auto;
  position: absolute;
...
`;
const LendingInfoImg1 = styled.img.attrs(() => ({
  src: LendingInfoIllu1,
}))`
  width: 170px;
  height: auto;
  position: absolute;
...
`;
const LendingInfoImg2 = styled.img.attrs(() => ({
  src: LendingInfoIllu2,
}))`
  width: 170px;
  height: auto;
  position: absolute;
  ...
  animation-duration: 0.4s;
`;
const LendingInfoImg3 = styled.img.attrs(() => ({
  src: LendingInfoIllu3,
}))`
  width: 170px;
  height: auto;
  position: absolute;
