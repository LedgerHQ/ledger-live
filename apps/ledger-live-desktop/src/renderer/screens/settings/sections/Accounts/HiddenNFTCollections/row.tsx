...
export const HiddenNftCollectionRow = ({
  ...
  const firstNft = useMemo(
    () => account?.nfts?.find(nft => nft.contract === contractAddress),
  ...
  return (
    <HiddenNftCollectionRowContainer>
      ...
      <IconContainer onClick={onUnhide} alignItems="center" justifyContent="center">
        <IconCross size={16} />
      </IconContainer>
    </HiddenNftCollectionRowContainer>
  );
...
const HiddenNftCollectionRowContainer = styled(Flex).attrs({
  alignItems: "center",
