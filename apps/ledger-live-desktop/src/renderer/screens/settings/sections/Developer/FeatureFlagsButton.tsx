...
export const FeatureFlagsContent = ({ visible }: any) => {
  const { t } = useTranslation();
              ...
              {focusedName === flagName ? (
                <Flex flexDirection="column" pl={6} rowGap={3}>
                  ...
                  <Flex p={3} backgroundColor="neutral.c30">
                    <Text whiteSpace="pre">{JSON.stringify(featureFlags[flagName], null, 2)}</Text>
                  </Flex>
                </Flex>
              ) : null}
            </>
...
export const FeatureFlagsDrawerButton = () => {
  ...
  return (
    <>
      ...
      <ButtonV3 mb="24px" type="main" onClick={() => setIsOpen(true)}>
...
const FeatureFlagsButton = () => {
  ...
  return (
    <Row
      ...
      desc={<FeatureFlagsContent visible={visible} />}
    >
