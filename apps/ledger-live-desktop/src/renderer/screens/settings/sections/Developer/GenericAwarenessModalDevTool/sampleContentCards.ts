...
export const sampleGenericAwarenessModalContentCards: GenericAwarenessModalContentCard[] = [
  ...
  },
  {
    ...
    imageUrl: getPicsumImageUrl("sample-prompt-app-start"),
  ...
  },
  {
    ...
    title: "Protect what you own",
    subtitle: "Self-custody keeps your assets under your control, not on an exchange.",
    imageUrl: getPicsumImageUrl("sample-prompt-banner"),
    primaryButtonLabel: "Discover signers",
    primaryButtonLink: "https://www.ledger.com/hardware-wallets",
