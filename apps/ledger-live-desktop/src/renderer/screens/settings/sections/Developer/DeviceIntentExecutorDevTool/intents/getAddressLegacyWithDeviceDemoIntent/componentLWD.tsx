...
export function GetAddressLegacyWithDeviceDemoIntentComponentLWD({
  ...
  return (
    <div className="flex w-full flex-col gap-16 px-16 py-24">
      <h3 className="heading-4-semi-bold text-center text-base">Legacy address intent</h3>
      {jobState?.type === "gotTransport" ? (
        ...
        <div className="flex flex-col gap-8">
          <span className="body-2-semi-bold text-success">Address derived (legacy withDevice)</span>
