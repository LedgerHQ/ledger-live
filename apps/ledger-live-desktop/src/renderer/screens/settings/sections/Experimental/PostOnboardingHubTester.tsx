...
const PostOnboardingHubTester = () => {
  ...
  const devicesSupportedByPostOnboarding = [
    ...
    },
    {
      ...
      translationKey: "testNanoSPostonboarding",
      dataTestId: "nanos-postonboarding-tester-button",
    },
    {
      deviceModelId: DeviceModelId.nanoSP,
      translationKey: "testNanoSPPostonboarding",
      dataTestId: "nanosp-postonboarding-tester-button",
    },
    {
      deviceModelId: DeviceModelId.nanoX,
      translationKey: "testNanoXPostonboarding",
      dataTestId: "nanox-postonboarding-tester-button",
    },
  ];
