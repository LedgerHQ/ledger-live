...
describe("Market utils", () => {
  ...
  describe("availability Swap or Buy", () => {
    describe("Should test availability for Buy action", () => {
      ...
      it("Should return true when ledgerIds contains available currency and isCurrencyAvailable returns true", () => {
      ...
      it("Should return false when ledgerIds contains currency but isCurrencyAvailable returns false", () => {
        const isAvailable = isAvailableOnBuy(
          // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
          {
            ledgerIds: ["btc"],
      ...
      it("Should return false when ledgerIds are not available", () => {
        const isAvailable = isAvailableOnBuy(
          // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
          {
            ledgerIds: ["ltc"],
    ...
    describe("Should test availability for Swap action", () => {
      ...
      it("Should return true when ledgerIds contains currency in the swap set", () => {
      ...
      it("Should return false when ledgerIds contains currency not in the swap set", () => {
        const isAvailable = isAvailableOnSwap(
          // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
          {
            ledgerIds: ["btc"],
      ...
      it("Should return false when ledgerIds are not in the swap set", () => {
        const isAvailable = isAvailableOnSwap(
          // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
          {
            ledgerIds: ["ltc"],
