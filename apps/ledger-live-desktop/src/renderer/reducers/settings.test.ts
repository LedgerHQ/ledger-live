...
describe("trackingEnabledSelector", () => {
  /** Frozen clock; staleness uses `needsConsentRenewal` (default interval from live-common). */
  ...
  describe("opt-in analytics", () => {
    ...
    it("should track if lastAnalyticsConsentDate is more than 365 days ago when renewal interval is null", () => {
