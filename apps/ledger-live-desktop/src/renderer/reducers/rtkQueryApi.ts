...
import { calApi, coinMarketCapApi, countervaluesApi, pushDevicesApi } from "@domain/api-services";
...
// Add new RTK Query API here. `@domain/api-services` entries own one backend each; the endpoints are
