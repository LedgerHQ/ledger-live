 ...
 * @param originalCurrency The original currency (can be a token or crypto currency).
 * @returns An object containing the account and optionally the parent account.
 */
