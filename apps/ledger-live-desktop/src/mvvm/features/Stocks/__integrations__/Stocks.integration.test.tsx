...
describe("Stocks section", () => {
  ...
  it("renders the top stocks in market-cap order, capped to the limit", () => {
    ...
    expect(screen.getByTestId("stock-item-ticker-aaplx")).toBeInTheDocument();
    expect(screen.getByTestId("stock-item-ticker-tslax")).toBeInTheDocument();
  ...
  it("shows skeleton rows while loading", () => {
    ...
    expect(screen.getByTestId("stocks-skeleton")).toBeInTheDocument();
  });
  ...
  it("skips stocks that have no ledger id", () => {
    ...
    expect(screen.getByTestId("stocks-list")).toBeInTheDocument();
    expect(screen.queryByTestId("stock-item-ticker-nolx")).not.toBeInTheDocument();
  });
