...
export function getExplorerUrl({
  ...
  return getCurrencyTransactionExplorerUrl(mainCurrency, operationHash);
}
...
function getCurrencyTransactionExplorerUrl(
  ...
  const familyExplorer = getLLDCoinFamily(mainCurrency.family).getTransactionExplorer;

  return (
    familyExplorer?.(explorerView, operation) ??
