 ...
 *   in `heading-3-semi-bold`, the FULL (non-truncated) address in
 *   `body-2`, the chain label, and three Lumen `TileButton`s — Send,
 *   Edit, Delete (destructive `text-error` tint).
 *
    ...
    <Dialog open={open} onOpenChange={onOpenChange} height="fit">
      <DialogContent>
        ...
        <DialogBody scrollbarWidth="auto" className="flex flex-col items-center gap-24 px-24 pb-24">
          <QrCodeWithIcon data={stickyEntry.addressHex} chainId={stickyEntry.chainId} />
