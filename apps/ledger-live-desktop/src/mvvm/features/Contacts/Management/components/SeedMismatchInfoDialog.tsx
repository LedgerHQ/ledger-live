 ...
 * contact was registered under a different seed (device returns `SW 0x6982`;
 * see `isSeedMismatchError`). Structurally mirrors `DestructiveConfirmDialog`
 * — same `bg-muted` badge, centred title + body — but reads as *informational*
 ...
 */
export function SeedMismatchInfoDialog({ open, onOpenChange }: Props) {
        ...
        >
          ...
          <div className="flex flex-col items-center gap-8 text-center">
            <h3 className="heading-3-semi-bold text-base">
              {t("contactsManagement.seedMismatchDialog.title")}
            </h3>
            <p className="body-2 text-muted">
              {t("contactsManagement.seedMismatchDialog.body")}
            </p>
          </div>
