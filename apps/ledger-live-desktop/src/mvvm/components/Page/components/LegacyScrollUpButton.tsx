...
interface LegacyScrollUpButtonProps {
...
/**
 * Legacy Scroll Up Button
 * Floating button to scroll back to top of the page
 */
export const LegacyScrollUpButton = memo(function LegacyScrollUpButton({
  isVisible,
  onClick,
}: LegacyScrollUpButtonProps) {
  ...
  return (
    <StyledButton
      ...
      data-testid="legacy-scroll-up-button"
    >
      <AngleUp size={20} />
    </StyledButton>
  );
