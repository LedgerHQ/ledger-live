...
const faq: { [key in Language]: string } = {
...
const terms: { [key in Language]: string } = {
...
const privacyPolicy: { [key in Language]: string } = {
...
const contactSupportWebview: { [key in Language]: string } = {
...
const buyNew: { [key in Language]: string } = {
