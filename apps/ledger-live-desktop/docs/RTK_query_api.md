...
To use the API slice in the app, the slice must be added to the `APIs` variable of the `~/renderer/reducers/rtkQueryApi.ts` file with the reducer path as the key:
