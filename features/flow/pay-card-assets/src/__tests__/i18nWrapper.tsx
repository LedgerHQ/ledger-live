...
export const CARD_ASSETS_COPY = {
  ...
  emptyDescription: "Add an asset to start using your card.",
  emptyCta: "Add asset",
      ...
      payTab: {
        card: {
          assets: {
            ...
            empty: {
              title: CARD_ASSETS_COPY.emptyTitle,
              description: CARD_ASSETS_COPY.emptyDescription,
              cta: CARD_ASSETS_COPY.emptyCta,
            },
            error: {
              title: CARD_ASSETS_COPY.errorTitle,
              description: CARD_ASSETS_COPY.errorDescription,
              cta: CARD_ASSETS_COPY.errorCta,
            },
            details: {
            ...
            manageDialog: {
              ...
              reorder: CARD_ASSETS_COPY.reorder,
