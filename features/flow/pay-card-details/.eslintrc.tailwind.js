...
module.exports = {
  ...
  rules: {
    ...
    // `dark` is the Lumen color-scheme class (toggled on <html> by ThemeProvider); it scopes the
    // always-dark card face and is provided by the host app's Tailwind, not a typo.
