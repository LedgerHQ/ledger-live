 ...
 * passes in — see [docs/configuration.md](../../../docs/configuration.md)
 */
 ...
 * mutable singleton — see [docs/configuration.md](../../../docs/configuration.md).
 */
 ...
 * value where you use it instead — see [docs/configuration.md](../../../docs/configuration.md).
 */
