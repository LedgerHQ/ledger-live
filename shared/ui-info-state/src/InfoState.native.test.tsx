...
import type { InfoStatePreset } from "./types.native";
...
describe("InfoState", () => {
  ...
  it("GIVEN a rendered InfoState with primary and secondary CTAs WHEN the user presses each CTA THEN the matching onPress handler is invoked", () => {
    // GIVEN
