...
describe("AccountAddress", () => {
  ...
  describe("isValid", () => {
    it("should return true for a valid address", () => {
      expect(AccountAddress.isValid("3kBx2h5Y2veb4hZgAJWPrr8RyQESKm5TjzF3ti1QQ4VSYLwK1G")).toBe(
        true,
      );
    });

    it("should return false for address shorter than 50 characters", () => {
      expect(AccountAddress.isValid("3kBx2h5Y2veb4hZgAJWPrr8RyQESKm5TjzF3ti1QQ4VS")).toBe(false);
    });
    ...
    it("should return false for invalid base58 encoding", () => {
      expect(AccountAddress.isValid("0".repeat(50))).toBe(false);
    });
  });
});
