...
> [!WARNING]
> **Status: DEPRECATED** — In maintenance mode and being progressively dismantled. Do **not** add new features, folders or top-level modules here. Bugfixes and edits to existing code are welcome. New shared logic belongs in the [monorepo layers](../../docs/monorepo-architecture.md), usually `features/platform/`.
