...
import { createBridges, makeCliTools, type MinaBridge } from "@ledgerhq/coin-mina/bridge";
...
const bridge: MinaBridge = createBridges(executeWithSigner(createSigner), getCoinConfig);
