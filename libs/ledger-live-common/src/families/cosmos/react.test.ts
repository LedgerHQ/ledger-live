...
import { loadSetupForFamily, registerCoinModules } from "../../coin-modules/registry";
...
describe("cosmos/react", () => {
  beforeAll(async () => {
    ...
    registerCoinModules(coinModuleLoaders.filter(l => l.family === "cosmos"));
    await loadSetupForFamily("cosmos");
