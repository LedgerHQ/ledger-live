...
import { createBridges, type TronBridge } from "@ledgerhq/coin-tron/bridge";
...
const bridge: TronBridge = createBridges(executeWithSigner(createSigner), getCurrencyConfig);
