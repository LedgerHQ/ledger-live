...
/**
 * The Tron transaction as the apps see it. It shadows the `Transaction` exported by
 * `@ledgerhq/coin-tron/types` — an explicit export wins over the star re-export above.
 */
