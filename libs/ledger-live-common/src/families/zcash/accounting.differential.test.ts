...
function account({ utxos = [100_000, 25_000], notes = [40_000, 10_000] } = {}): Account {
  ...
  return {
    ...
    privateInfo: {
      orchardBalance: shieldedNotes.reduce((sum, n) => sum.plus(n.amount), new BigNumber(0)),
      ...
      transactions: [
        {
          ...
          decryptedData: { orchard_outputs: shieldedNotes, sapling_outputs: [] },
        },
      ],
    },
