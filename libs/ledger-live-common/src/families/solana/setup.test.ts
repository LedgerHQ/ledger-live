...
const BASE58_ENVELOPE =
  "45NdPyVmTqFvRK3ACH6HUmipn5rKzKcjJjbvGxAD8eCX9RkEFpgS5hZKGh4y8n23ccGrUGGyuRCWAcYeQQWzMMmsM6VXy9cp5RFa5gL1k9UZRrN2FpkoPPxEZZcJ35nKapXnfJdrSVMkRvcuDSPPbGJq481RpVMHJSbGoTpehHsZk2VX82JyJvEMBiT1FLZexQpvbFrDNzDsn5p5ggWMejnCKiwSmYJhjCbUTqMoi";
  ...
  describe("Testing message signer", () => {
    it("should call the underlying signer for off-chain message signature", async () => {
      ...
      expect((args[1] as Buffer).toString("hex")).toEqual(
        "ff736f6c616e61206f6666636861696e01016b4a46c53959cac0eff146ab323053cfc503321adfd453a7c67c91a24be032353463366636653637323034663636363632643433363836313639366532303534363537333734323034643635373337333631363736353265",
      );
