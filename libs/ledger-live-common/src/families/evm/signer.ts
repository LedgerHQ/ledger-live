  ...
  return {
    ...
    signTransaction: async (path, tx, domain) => {
      ...
      const loadConfig: LoadConfig = {
        calServiceURL: getEnv<string>("CAL_SERVICE_URL"),
        cryptoassetsBaseURL: getEnv<string>("DYNAMIC_CAL_BASE_URL"),
        nftExplorerBaseURL: getEnv<string>("NFT_METADATA_SERVICE") + "/v1/ethereum",
      };
