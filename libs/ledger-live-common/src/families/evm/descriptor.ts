...
const eip1559Inputs: readonly CustomFeeInputDescriptor[] = [
  {
    ...
    type: "number",
    unitLabel: "Gwei",
    i18nLabelKey: "newSendFlow.customFees.maxFee",
    suggestedRange: {
  ...
  },
  {
    ...
    type: "number",
    unitLabel: "Gwei",
    i18nLabelKey: "newSendFlow.customFees.maxPriorityFee",
    helperInfo: {
      i18nKey: "newSendFlow.customFees.nextBlock",
  ...
  },
  {
    ...
    type: "number",
    unitLabel: "Gwei",
    i18nLabelKey: "newSendFlow.customFees.gasLimit",
  },
];
