...
describe("BitcoinApi", () => {
  ...
  it("getRelayFee unit test", async () => {
    // @ts-expect-error method is mocked
    network.mockResolvedValue({
      data: {
  ...
  it("getFees unit test", async () => {
    // @ts-expect-error method is mocked
    network.mockResolvedValue({
      data: { "2": 555985, "4": 504992, "6": 479059, last_updated: 1683675584 },
    });
  ...
  it("getCurrentBlock unit test", async () => {
    // @ts-expect-error method is mocked
    network.mockResolvedValue({
      data: {
