...
export { createFixtureAccount, createFixtureTokenAccount };

export function createWalletAPIEthereumTransaction(): WalletAPITransaction {
  return {
    family: "ethereum",
...
export function createTokenAccount(id = "32", parentId = "whatever"): TokenAccount {
  return {
    type: "TokenAccount",
    id,
    parentId,
