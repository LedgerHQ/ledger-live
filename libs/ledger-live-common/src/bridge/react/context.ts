...
export const BridgeSyncContext: React.Context<Sync> = React.createContext(_ => {});
...
export const useBridgeSyncState = (): BridgeSyncState => useContext(BridgeSyncStateContext);
