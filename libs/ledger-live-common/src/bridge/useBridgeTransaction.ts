...
export type Result<T extends Transaction = Transaction> = {
  ...
  account: AccountLike | null | undefined;
  parentAccount: Account | null | undefined;
  setAccount: (account: AccountLike, parentAccount: Account | null | undefined, bridge: AccountBridge<any>) => void;
...
const useBridgeTransaction = <T extends Transaction = Transaction>(
  ...
  const setAccount = useCallback(
    (account: AccountLike, parentAccount: Account | null | undefined, bridge: AccountBridge<any>) => {
      dispatch({
        type: "setAccount",
        account,
        parentAccount,
