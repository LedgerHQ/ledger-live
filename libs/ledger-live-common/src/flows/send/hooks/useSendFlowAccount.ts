  ...
  switch (action.type) {
    case "SET_ACCOUNT":
      return {
        ...
        currency: getAccountCurrency(action.account) as unknown as CryptoOrTokenCurrency,
      };
    case "CLEAR":
...
function createInitialState(
  ...
  return {
    ...
    currency: getAccountCurrency(initialAccount) as unknown as CryptoOrTokenCurrency,
  };
}
