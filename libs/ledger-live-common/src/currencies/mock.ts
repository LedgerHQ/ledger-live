...
export const CURRENCIES_LIST: CryptoCurrency[] = [
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("axelar"),
    coinType: 118,
    name: "Axelar",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("quicksilver"),
    coinType: 118,
    name: "Quicksilver",
    managerAppName: "Cosmos",
    ticker: "QCK",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("persistence"),
    coinType: 118,
    name: "Persistence",
    managerAppName: "Cosmos",
    ticker: "XPRT",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("polkadot"),
    coinType: 354,
    name: "Polkadot",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("solana"),
    coinType: 501,
    name: "Solana",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("cosmos"),
    coinType: 118,
    name: "Cosmos",
    managerAppName: "Cosmos",
    ticker: "ATOM",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("celo"),
    coinType: 52752,
    name: "Celo",
    managerAppName: "Celo",
    blockAvgTime: 5,
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("tezos"),
    coinType: 1729,
    name: "Tezos",
  ...
  },
  {
    type: "CryptoCurrency",
    // id: "multiversx",
    id: CryptoCurrencySchema.shape.id.parse("elrond"),
    coinType: 508,
    name: "MultiversX",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("cardano"),
    coinType: 1815,
    name: "Cardano",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("osmo"),
    coinType: 118,
    name: "Osmosis",
    managerAppName: "Cosmos",
    ticker: "OSMO",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("near"),
    coinType: 397,
    name: "NEAR",
    managerAppName: "NEAR",
    ticker: "NEAR",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("mantra"),
    coinType: 118,
    name: "Mantra",
    managerAppName: "Cosmos",
    ticker: "MANTRA",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("crypto_org"),
    coinType: 394,
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("xion"),
    coinType: 118,
    name: "Verona",
    managerAppName: "Cosmos",
    ticker: "VERONA",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("zenrock"),
    coinType: 118,
    name: "Zenrock",
    managerAppName: "Cosmos",
    ticker: "ROCK",
  ...
  {
    type: "CryptoCurrency",
    id: CryptoCurrencySchema.shape.id.parse("babylon"),
    coinType: 118,
    name: "Babylon",
    managerAppName: "Cosmos",
    ticker: "BABY",
