...
const ALLOWED_SOURCES = [
  ...
  // Lazy loaders for generic-alpaca — per-family modules and cross-family utilities.
  // All coin-* and families/* imports for generic-alpaca are consolidated here.
  "ledger-live-common/src/bridge/generic-alpaca/loaders/",
...
test("coin-* eager imports — must be zero outside allowed zones", () => {
  ...
  const KNOWN: Record<string, string> = {
    // Fixed by LIVE-29326 in develop; present only until this branch is rebased.
