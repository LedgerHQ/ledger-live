...
import fileCoinCurrencyConfig, { type FileCoinCurrencyConfig } from "./config";
...
export function createBridges(
  signerContext: SignerContext<FileCoinSigner>,
  coinConfig: CoinConfig<FileCoinCurrencyConfig>,
) {
  fileCoinCurrencyConfig.setCoinConfig(coinConfig);
