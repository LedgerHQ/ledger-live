...
- [#18190](https://github.com/LedgerHQ/ledger-live/pull/18190) [`4f541c2`](https://github.com/LedgerHQ/ledger-live/commit/4f541c2f45d508dd12b4d4ff92dec294e6005865) Thanks [@cted-ledger](https://github.com/cted-ledger)! - feat(coin-filecoin): add CoinModuleApi (Alpaca) support for native FIL and FEVM ERC-20 tokens via `createApi` factory. Legacy `createBridges` export unchanged.

- [#19174](https://github.com/LedgerHQ/ledger-live/pull/19174) [`c4ee26d`](https://github.com/LedgerHQ/ledger-live/commit/c4ee26d18dacfcee597357de4b9dbab9fda01dbb) Thanks [@vladyslavchupovskiy-ext-art](https://github.com/vladyslavchupovskiy-ext-art)! - Fix Filecoin transaction broadcast failing for amounts >= 1000 FIL. The amount was serialized with `BigNumber.toString()`, which emits exponential notation ("1e+21") at 1e21 attoFIL (1000 FIL) and up, causing the broadcast backend to reject it with a 500. Serialize with `toFixed()` so the value is always a plain integer string.
...
- [#13372](https://github.com/LedgerHQ/ledger-live/pull/13372) [`96a0821`](https://github.com/LedgerHQ/ledger-live/commit/96a08210ae9a40c9b4c39cdbb85acf742d43c3a4) Thanks [@emmanuelm41](https://github.com/emmanuelm41)! - bump filecoin js package version and adapt integration to new types
...
- [#12495](https://github.com/LedgerHQ/ledger-live/pull/12495) [`59d6da4`](https://github.com/LedgerHQ/ledger-live/commit/59d6da447568ad45aadf7923a04e077bc0953a5b) Thanks [@gre-ledger](https://github.com/gre-ledger)! - Prepare filecoin for async CryptoAssetsStore migration - add await to token lookups
