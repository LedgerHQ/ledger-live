...
import {
  ...
  getTokenCurrencyFromCALByIndex,
...
describe("bridge utils", () => {
  ...
  describe("getSubAccounts", () => {
    it("returns sub account based on operations and mirror tokens", async () => {
      const firstTokenCurrencyFromCAL = getTokenCurrencyFromCALByIndex(0);
      const secondTokenCurrencyFromCAL = getTokenCurrencyFromCALByIndex(1);
      const mockedAccount = getMockedAccount();
    ...
    it("returns sub account for hts token with no operations yet (e.g. right after association)", async () => {
      const tokenCurrencyFromCAL = getTokenCurrencyFromCALByIndex(0);
      const mockedAccount = getMockedAccount();
