...
- [#20176](https://github.com/LedgerHQ/ledger-live/pull/20176) [`2aa082f`](https://github.com/LedgerHQ/ledger-live/commit/2aa082f57f3c90124173a2bd2d552c0bb05c6812) Thanks [@henri-ly](https://github.com/henri-ly)! - fix(coin-solana): drop warmupCooldownRate from stake schema
...
- [#18668](https://github.com/LedgerHQ/ledger-live/pull/18668) [`b79bde9`](https://github.com/LedgerHQ/ledger-live/commit/b79bde945f121cfe05aeaa41043723a37c2b4410) Thanks [@qperrot](https://github.com/qperrot)! - Block Solana token transfers when spendable balance can't cover both the ATA rent (mint-aware for Token-2022) and the fee
...
- [#16681](https://github.com/LedgerHQ/ledger-live/pull/16681) [`5457ea4`](https://github.com/LedgerHQ/ledger-live/commit/5457ea4d13f10341403fdfec2d1fbef64cc14682) Thanks [@jnicoulaud-ledger](https://github.com/jnicoulaud-ledger)! - chore(coin-solana): make RPC URLs configurable in coin config
...
- [#16688](https://github.com/LedgerHQ/ledger-live/pull/16688) [`4daea73`](https://github.com/LedgerHQ/ledger-live/commit/4daea739d928bbd0c3c3c575ad97e30907acaeb5) Thanks [@cted-ledger](https://github.com/cted-ledger)! - Add stakes entries to getBalance result in Alpaca API for Solana
...
- [#15895](https://github.com/LedgerHQ/ledger-live/pull/15895) [`206730c`](https://github.com/LedgerHQ/ledger-live/commit/206730c71ded9a6ea54254ad39da796c38f4c7ee) Thanks [@cted-ledger](https://github.com/cted-ledger)! - Adapt coin-solana alpaca API to be compliant with solana coin tester scenarii
...
- [#15897](https://github.com/LedgerHQ/ledger-live/pull/15897) [`e31b1cd`](https://github.com/LedgerHQ/ledger-live/commit/e31b1cdfcfc03169b541d6e071471eef08bb881f) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - chore(coin-solana): intercept error code -32020 on `getSignaturesForAddress`

- [#15586](https://github.com/LedgerHQ/ledger-live/pull/15586) [`39d4880`](https://github.com/LedgerHQ/ledger-live/commit/39d48807a35ced14767c0747faff4e2c2b09420d) Thanks [@cted-ledger](https://github.com/cted-ledger)! - coin-solana: Implements validateIntent alpaca api method
  live-common: Introduce solana bridge api
...
- [#15606](https://github.com/LedgerHQ/ledger-live/pull/15606) [`a8190c5`](https://github.com/LedgerHQ/ledger-live/commit/a8190c5ce7d0d5435bbd59a1f3bd8e1f56f119d2) Thanks [@qperrot](https://github.com/qperrot)! - Fix: Solana error when sending too low amount to a not funded account
...
- [#15290](https://github.com/LedgerHQ/ledger-live/pull/15290) [`0d89669`](https://github.com/LedgerHQ/ledger-live/commit/0d89669b2a5d85f79cfb95a80288414bc58f6c71) Thanks [@cted-ledger](https://github.com/cted-ledger)! - coin-solana alpaca api broadcast

- [#15322](https://github.com/LedgerHQ/ledger-live/pull/15322) [`51e7ee5`](https://github.com/LedgerHQ/ledger-live/commit/51e7ee5e84a70afa726b082e20b21167d2cbe492) Thanks [@cted-ledger](https://github.com/cted-ledger)! - coin-solana alpaca api lastBlock implementation
...
- [#15321](https://github.com/LedgerHQ/ledger-live/pull/15321) [`a1f550b`](https://github.com/LedgerHQ/ledger-live/commit/a1f550b8c150d698e8e2f9492e909514c6a453ca) Thanks [@cted-ledger](https://github.com/cted-ledger)! - coin-solana alpaca api combine implementation
...
- [#13820](https://github.com/LedgerHQ/ledger-live/pull/13820) [`1531219`](https://github.com/LedgerHQ/ledger-live/commit/1531219874faf54259a821033fb55cec85671968) Thanks [@qperrot](https://github.com/qperrot)! - Fix: Set errors.transaction to the same memo error so an overlong memo blocks the transaction (and disables continue)
...
- [#13451](https://github.com/LedgerHQ/ledger-live/pull/13451) [`753027f`](https://github.com/LedgerHQ/ledger-live/commit/753027fb4579a990080907aad4084572dabc7a3c) Thanks [@dilaouid](https://github.com/dilaouid)! - feat: display and enable withdrawable rewards of inactive stake for SOL
...
- [#13044](https://github.com/LedgerHQ/ledger-live/pull/13044) [`9823ce1`](https://github.com/LedgerHQ/ledger-live/commit/9823ce1ba3f1258ad95469787a66817b42f9f4de) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - fix(coin-solana): remove LRU cache for Stake RPC methods
...
- [#12628](https://github.com/LedgerHQ/ledger-live/pull/12628) [`9be4b9f`](https://github.com/LedgerHQ/ledger-live/commit/9be4b9fcd7d01b600561302113654b17854856ab) Thanks [@gre-ledger](https://github.com/gre-ledger)! - Remove Solana token update in `preload` and `hydrate` function

- [#12951](https://github.com/LedgerHQ/ledger-live/pull/12951) [`3e0c113`](https://github.com/LedgerHQ/ledger-live/commit/3e0c1137e8e2c34fab711aa76591c10ad491ce5a) Thanks [@Justkant](https://github.com/Justkant)! - refactor(coin-solana): remove queued and cached API wrappers
...
- [#12820](https://github.com/LedgerHQ/ledger-live/pull/12820) [`d02914b`](https://github.com/LedgerHQ/ledger-live/commit/d02914bd12cadcff4720dd77d05dc5b4665aae6f) Thanks [@qperrot](https://github.com/qperrot)! - Fix issue with incorrect association between transaction signature and transaction history during synchronization process.
...
- [#10396](https://github.com/LedgerHQ/ledger-live/pull/10396) [`1860aa3`](https://github.com/LedgerHQ/ledger-live/commit/1860aa33a013716fbd128089faaf7562de1748c8) Thanks [@Justkant](https://github.com/Justkant)! - fix: missing raw field when building Solana raw transaction
...
- [#9807](https://github.com/LedgerHQ/ledger-live/pull/9807) [`157f908`](https://github.com/LedgerHQ/ledger-live/commit/157f908759ed2f41fb823e172762931ebba518a5) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - refactor(coin-solana): move HTTP calls to `network` folder
