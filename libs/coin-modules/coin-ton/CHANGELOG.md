...
- [#20449](https://github.com/LedgerHQ/ledger-live/pull/20449) [`d0d0802`](https://github.com/LedgerHQ/ledger-live/commit/d0d080296b51d28c7b3550c1af9652067767e8f3) Thanks [@lysyi3m](https://github.com/lysyi3m)! - Fix error precedence in `validateAmount`: `TonMinimumRequired` no longer overwrites `NotEnoughBalance` when both conditions are true. The keep-alive minimum error now only surfaces when it is the binding constraint.
