...
//
//     const result = selectUtxos(sampleUtxoSet, UtxoStrategy.FIFO, recipient_is_ecdsa, amount, feerate);
//
...
//     expect(() => selectUtxos(sampleUtxoSet, UtxoStrategy.FIFO, recipient_is_ecdsa, amount, feerate)).toThrow(Error);
//   });
// });
