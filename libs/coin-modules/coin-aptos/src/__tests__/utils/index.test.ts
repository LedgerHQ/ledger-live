...
describe("endpointByCurrencyId", () => {
  it("gets the aptos endpoint based on the currency id", () => {
    expect(endpointByCurrencyId("aptos")).toBe("https://apt.coin.ledger.com/node");
    expect(endpointByCurrencyId("aptos_testnet")).toBe("https://api.testnet.aptoslabs.com/v1");
