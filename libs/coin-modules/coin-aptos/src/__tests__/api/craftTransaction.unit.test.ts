...
describe("craftTransaction", () => {
  ...
  it("creates a coin transaction", async () => {
    ...
    const txArg: TransactionIntent = {
      ...
      amount: 10n,
      asset: { assetType: "token", assetOwner: "coin", assetReference: "0x42::token::Token" },
    };
  ...
  it("creates a fungible_asset token transaction using all amount available", async () => {
    ...
    const txArg: TransactionIntent = {
      ...
      recipient: RECIPIENT_ADDR,
      amount: 0n,
      asset: { assetType: "token", assetOwner: "fungible_asset", assetReference: "0x42" },
    };
  ...
  it("throws an exception for invalid tokenType", async () => {
    ...
    const txArg: TransactionIntent = {
      ...
      recipient: RECIPIENT_ADDR,
      amount: 10n,
      asset: { assetType: "token", assetOwner: "asset", assetReference: "0x42::token::Token" },
    };
