...
- [#19148](https://github.com/LedgerHQ/ledger-live/pull/19148) [`41e0064`](https://github.com/LedgerHQ/ledger-live/commit/41e0064e837c2b99750b563d219748d40305b304) Thanks [@pawell24](https://github.com/pawell24)! - aptos: stop dropping transactions that no longer emit transfer events from the account history.
...
- [#18720](https://github.com/LedgerHQ/ledger-live/pull/18720) [`5712729`](https://github.com/LedgerHQ/ledger-live/commit/57127292c27638df6d74d6b3449c360bf33f5cb8) Thanks [@semeano](https://github.com/semeano)! - Set max spendable amount with looser fee calculations.

- [#18458](https://github.com/LedgerHQ/ledger-live/pull/18458) [`873c11e`](https://github.com/LedgerHQ/ledger-live/commit/873c11e22d71a740642c029914638633dec14e2a) Thanks [@pawell24](https://github.com/pawell24)! - Fix account creation failing with a TypeError on Aptos accounts that have a coin to fungible-asset migration transaction in their history.

- [#18477](https://github.com/LedgerHQ/ledger-live/pull/18477) [`914d8ba`](https://github.com/LedgerHQ/ledger-live/commit/914d8ba371892d52e527c814be8ffdba308c172d) Thanks [@pawell24](https://github.com/pawell24)! - Fix network fees showing 0 when sending an Aptos token with an amount whose raw value exceeds the native APT balance. Fee estimation is now gated by the token balance instead of the native balance.

- [#18179](https://github.com/LedgerHQ/ledger-live/pull/18179) [`c3712fa`](https://github.com/LedgerHQ/ledger-live/commit/c3712fa1cd932e73b8457e1e86a1f04df3b62dbb) Thanks [@semeano](https://github.com/semeano)! - Fix Aptos transactions wrongly reporting a GasInsufficientBalance error after using "Use max". Gas estimation now always simulates against the default gas options instead of reusing a stale maxGasAmount/gasUnitPrice computed for a previous transaction.
