...
jest.mock("@ledgerhq/ledger-wallet-framework/serialization/index", () => ({
...
describe("synchronisation", () => {
  ...
  describe("getAccountShape", () => {
    ...
    it("infers sub-operations for each operation", async () => {
      const { inferSubOperations } = jest.requireMock(
        "@ledgerhq/ledger-wallet-framework/serialization/index",
      );
