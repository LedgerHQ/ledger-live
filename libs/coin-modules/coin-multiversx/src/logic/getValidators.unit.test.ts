...
describe("getValidators", () => {
  const createProvider = (
    // Allow explicit `undefined` overrides (exactOptionalPropertyTypes) — e.g. `disabled: undefined`.
    overrides: { [K in keyof MultiversXProvider]?: MultiversXProvider[K] | undefined } = {},
  ): MultiversXProvider =>
    ({
