  ...
  describe("mixed states - precedence rules (AC: #5)", () => {
    it("deactivating takes precedence over inactive (userUnBondable)", () => {
      const delegation = createDelegation({
        ...
        userUndelegatedList: [{ amount: "200000000000000000", seconds: 3600 }],
      });
    ...
    it("deactivating takes precedence over active stake", () => {
      const delegation = createDelegation({
        ...
        claimableRewards: "50000000000000000",
        userUnBondable: "0",
        userUndelegatedList: [{ amount: "200000000000000000", seconds: 7200 }],
      });
  ...
  describe("edge cases", () => {
    it("handles undelegation with amount 0 and seconds > 0 (ignores empty amounts)", () => {
      const delegation = createDelegation({
        ...
        claimableRewards: "0",
        userUnBondable: "0",
        userUndelegatedList: [{ amount: "0", seconds: 3600 }],
      });
    ...
    it("handles undelegation with amount 0 and seconds === 0", () => {
      const delegation = createDelegation({
        ...
        claimableRewards: "0",
        userUnBondable: "0",
        userUndelegatedList: [{ amount: "0", seconds: 0 }],
      });
    ...
    it("handles very large stake amounts", () => {
      const delegation = createDelegation({
        userActiveStake: "999999999999999999999999999",
        claimableRewards: "0",
        userUnBondable: "0",
        userUndelegatedList: [],
      });
