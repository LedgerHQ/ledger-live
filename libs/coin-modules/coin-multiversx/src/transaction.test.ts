...
describe("transaction", () => {
  ...
  describe("module exports", () => {
    it("exports all required functions", () => {
      expect(typeof transactionModule.formatTransaction).toBe("function");
      expect(typeof transactionModule.fromTransactionRaw).toBe("function");
      expect(typeof transactionModule.toTransactionRaw).toBe("function");
      expect(typeof transactionModule.fromTransactionStatusRaw).toBe("function");
      expect(typeof transactionModule.toTransactionStatusRaw).toBe("function");
      expect(typeof transactionModule.formatTransactionStatus).toBe("function");
    });
  });
});
