...
// Short retry delay for SEI staking calls. The SEI staking precompile returns
...
const SEI_STAKING_RETRY_DELAY_MS = 300;
    ...
    async rpcProvider => {
      ...
      try {
        ...
        if (isSeiMissingDelegationError(currencyId, error)) {
          ...
          await delay(SEI_STAKING_RETRY_DELAY_MS);
          ...
          try {
            ...
            throw retryError; // Let withRetries handle other errors
          }
        }
