...
describe("specs", () => {
  ...
  describe("algorand AppSpec", () => {
    ...
    it("should have currency defined", () => {
      expect(algorand.currency).toBeDefined();
    ...
    it("should have genericDeviceAction", () => {
      expect(algorand.genericDeviceAction).toBeDefined();
    });

    it("should have mutations array", () => {
      expect(algorand.mutations).toBeDefined();
  ...
  describe("mutations", () => {
    ...
    describe("move ~50%", () => {
      ...
      it("should have testDestination", () => {
        expect(mutation?.testDestination).toBeDefined();
      });
