...
import type { AlgorandAccount, AlgorandTransaction, TransactionStatus } from "./types";
...
export const buildSignOperation =
  ...
  ): AccountBridge<AlgorandTransaction, TransactionStatus, AlgorandAccount>["signOperation"] =>
