...
const mockGetAllAccountTransactions = network.getAllAccountTransactions as jest.MockedFunction<
  typeof network.getAllAccountTransactions
>;
...
describe("listOperations", () => {
  ...
  it("should return empty array when no transactions", async () => {
    mockGetAllAccountTransactions.mockResolvedValue([]);
  ...
  it("should convert payment transaction to OUT operation for sender", async () => {
    ...
    mockGetAllAccountTransactions.mockResolvedValue([tx]);
  ...
  it("should sort operations in descending order", async () => {
    ...
    mockGetAllAccountTransactions.mockResolvedValue(txs);
  ...
  it("should propagate network errors", async () => {
    mockGetAllAccountTransactions.mockRejectedValue(new Error("Network error"));
