...
export const CARDANO_API_ENDPOINT = getEnv<string>("CARDANO_API_ENDPOINT");
export const CARDANO_TESTNET_API_ENDPOINT = getEnv<string>("CARDANO_TESTNET_API_ENDPOINT");
...
export const CARDANO_EPOCH_PARAMS_ENDPOINT = getEnv<string>("CARDANO_EPOCH_PARAMS_ENDPOINT");
export const CARDANO_TESTNET_EPOCH_PARAMS_ENDPOINT = getEnv<string>(
