...
export class CardanoMinAmountError extends Error {
  ...
  constructor(message = "CardanoMinAmountError", fields?: Record<string, unknown>) {
    super(message);
...
export class CardanoStakeKeyDepositError extends Error {
  ...
  constructor(message = "CardanoStakeKeyDepositError", fields?: Record<string, unknown>) {
    super(message);
    if (fields) Object.assign(this, fields);
  }
}
...
export class CardanoNotEnoughFunds extends Error {
  ...
  constructor(message = "CardanoNotEnoughFunds") {
    super(message);
  }
}
...
export class CardanoInvalidPoolId extends Error {
  ...
  constructor(message = "CardanoInvalidPoolId") {
    super(message);
  }
}
...
export class CardanoFeeHigh extends Error {
  ...
  constructor(message = "CardanoFeeHigh") {
    super(message);
  }
}
...
export class CardanoFeeTooHigh extends Error {
  ...
  constructor(message = "CardanoFeeTooHigh") {
    super(message);
  }
}
...
export class CardanoInvalidProtoParams extends Error {
  ...
  constructor(message = "CardanoInvalidProtoParams") {
    super(message);
  }
}
...
export class CardanoMemoExceededSizeError extends Error {
  ...
  constructor(message = "CardanoMemoExceededSizeError") {
    super(message);
  }
}
