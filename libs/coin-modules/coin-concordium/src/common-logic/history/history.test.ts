...
describe("history", () => {
  ...
  describe("getBlock", () => {
    it("should return block from grpc client by height", async () => {
      ...
      // THEN
      expect(getBlockByHeightMock).toHaveBeenCalledWith(1000, mockCurrency);
  ...
  describe("getBlockInfo", () => {
    it("should return block info from grpc client by height", async () => {
      ...
      // THEN
      expect(getBlockInfoByHeightMock).toHaveBeenCalledWith(2000, mockCurrency);
  ...
  describe("listOperations", () => {
    it("should use grpc client when minHeight > 0", async () => {
      ...
      // THEN
      expect(getOperationsGrpcMock).toHaveBeenCalledWith(
        VALID_ADDRESS,
        { minHeight: 100 },
        mockCurrency,
      );
