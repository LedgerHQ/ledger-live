...
/**
 * Errors that say the command did not take effect: the canister refused it, the replica rejected
 * it, or the node never took the message at all. Nothing ran, so re-signing repeats nothing.
 */
