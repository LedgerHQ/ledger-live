...
// package.json resolves `@ledgerhq/coin-zcash/network/ZCash` to this file
// instead of `../ZCash.ts`.
//
// The real `ZCash.ts` pulls in `./engine.ts`, which imports
...
//
// If an actual sync is attempted on mobile (e.g. this module's
