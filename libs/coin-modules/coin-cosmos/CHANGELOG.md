...
- [#19100](https://github.com/LedgerHQ/ledger-live/pull/19100) [`c5763f6`](https://github.com/LedgerHQ/ledger-live/commit/c5763f6171f49d2b9e679b982804e68843800450) Thanks [@amaslakov](https://github.com/amaslakov)! - Implement `signRawOperation` for Cosmos: sign an externally-built amino `StdSignDoc` (e.g. from WalletConnect `cosmos_signAmino`) verbatim and return the detached 64-byte secp256k1 signature, without broadcasting. Previously a throwing stub.
...
- [#17781](https://github.com/LedgerHQ/ledger-live/pull/17781) [`607b032`](https://github.com/LedgerHQ/ledger-live/commit/607b03228d5e648a0611c316c6ab71a60365f349) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - fix(coin-cosmos): use correct query params when fetching transactions
...
- [#18631](https://github.com/LedgerHQ/ledger-live/pull/18631) [`64b8071`](https://github.com/LedgerHQ/ledger-live/commit/64b8071125821693ef325a32a9437c75ecbe2f06) Thanks [@amaslakov](https://github.com/amaslakov)! - Build Babylon (BABY) staking transactions by wrapping delegate/undelegate/redelegate messages in the x/epoching MsgWrapped\* envelope (amino + proto). Chain-specific staking message types now live on the chain classes (Babylon, Zenrock) instead of inline currency-id checks.

- [#18687](https://github.com/LedgerHQ/ledger-live/pull/18687) [`9dc9a1f`](https://github.com/LedgerHQ/ledger-live/commit/9dc9a1f6e9767a3056d88d63a36d5e20bc305f48) Thanks [@amaslakov](https://github.com/amaslakov)! - Parse babylon x/epoching wrapped staking messages (MsgWrapped\*) so delegate, undelegate and redelegate operations appear in account history

- [#18574](https://github.com/LedgerHQ/ledger-live/pull/18574) [`e93a936`](https://github.com/LedgerHQ/ledger-live/commit/e93a9367e61d8f060849782c7b5b95371979faf2) Thanks [@amaslakov](https://github.com/amaslakov)! - Show pending (epoch-queued) Babylon staking positions by merging the x/epoching message queue into staking positions during sync
...
- [#18350](https://github.com/LedgerHQ/ledger-live/pull/18350) [`558e633`](https://github.com/LedgerHQ/ledger-live/commit/558e633d633b73fd5b7f9bd6845ef2902ed60405) Thanks [@dilaouid](https://github.com/dilaouid)! - fix(coin-cosmos): slice unbondings to avoid validators crashes
...
- [#17722](https://github.com/LedgerHQ/ledger-live/pull/17722) [`2188360`](https://github.com/LedgerHQ/ledger-live/commit/2188360b016a70080b82d0dfeb76f3c417c7270e) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - chore: align default config with Firebase
...
- [#16695](https://github.com/LedgerHQ/ledger-live/pull/16695) [`18b98d9`](https://github.com/LedgerHQ/ledger-live/commit/18b98d93205abf9165753400eeb0ce57d9310aea) Thanks [@qperrot](https://github.com/qperrot)! - Fix: new mantra min gas price set to 40000000000

- [#16725](https://github.com/LedgerHQ/ledger-live/pull/16725) [`8c0653d`](https://github.com/LedgerHQ/ledger-live/commit/8c0653ddb8e405a3aafdd2c0e708feb62f6952d7) Thanks [@qperrot](https://github.com/qperrot)! - fix: update zenrock lcd from https://api.diamond.zenrocklabs.io to https://zenrock.api.m.stavr.tech
...
- [#16080](https://github.com/LedgerHQ/ledger-live/pull/16080) [`5820298`](https://github.com/LedgerHQ/ledger-live/commit/582029899253b1a1aa01894981de2a7a5c896f3b) Thanks [@gre-ledger](https://github.com/gre-ledger)! - fix cryptoFactory crashing when coinConfig is not yet initialized
...
- [#14230](https://github.com/LedgerHQ/ledger-live/pull/14230) [`3232194`](https://github.com/LedgerHQ/ledger-live/commit/32321942e8fbc9a77597d95e432986273fbda932) Thanks [@henri-ly](https://github.com/henri-ly)! - fix: coin-config is consume by cryptoFactory
...
- [#14049](https://github.com/LedgerHQ/ledger-live/pull/14049) [`7dbe08b`](https://github.com/LedgerHQ/ledger-live/commit/7dbe08b72ebae5ee707cc06826715341d2678404) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - chore(coin-cosmos): stringify JSON error
...
- [#13445](https://github.com/LedgerHQ/ledger-live/pull/13445) [`4259445`](https://github.com/LedgerHQ/ledger-live/commit/4259445dfcdbd102269c004820cf3d7774e930c0) Thanks [@gre-ledger](https://github.com/gre-ledger)! - Update @cosmos/\* libraries
...
- [#13251](https://github.com/LedgerHQ/ledger-live/pull/13251) [`e89716e`](https://github.com/LedgerHQ/ledger-live/commit/e89716ea7ff94dc1242a375de3625d54314e5207) Thanks [@francois-guerin-ledger](https://github.com/francois-guerin-ledger)! - conf(coin-cosmos): use PublicNode for Axelar
...
- [#13052](https://github.com/LedgerHQ/ledger-live/pull/13052) [`d4bad44`](https://github.com/LedgerHQ/ledger-live/commit/d4bad4433c3fb083d95820d2927a9e8beeaf244f) Thanks [@qperrot](https://github.com/qperrot)! - Staking : Deprecate Ledger node for Persistence & Quicksilver on LWD and LWM
...
- [#12665](https://github.com/LedgerHQ/ledger-live/pull/12665) [`314bebb`](https://github.com/LedgerHQ/ledger-live/commit/314bebb2c07c1b2e7a6e22964b3ebd5c4e4362d4) Thanks [@hedi-edelbloute](https://github.com/hedi-edelbloute)! - Update osmo mingasprice
...
- [#9504](https://github.com/LedgerHQ/ledger-live/pull/9504) [`b72091d`](https://github.com/LedgerHQ/ledger-live/commit/b72091d872805b7eae4e6219cb2be0a67974c582) Thanks [@qperrot](https://github.com/qperrot)! - Fix cannot read lcd
...
- [#7621](https://github.com/LedgerHQ/ledger-live/pull/7621) [`1605678`](https://github.com/LedgerHQ/ledger-live/commit/1605678a4c43ce85b19bd549b295f3c67ff1dcb9) Thanks [@lambertkevin](https://github.com/lambertkevin)! - Update `axios` to fixed version `1.7.3`
