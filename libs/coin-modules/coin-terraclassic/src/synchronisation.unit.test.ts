...
const baseTxMock = {
  ...
  tx: {
    auth_info: {
      ...
      fee: { amount: [{ denom: "uluna", amount: new BigNumber(1) }] },
    },
  },
};
...
function mockCosmosTx(tx: Partial<CosmosTx>) {
  return {
    ...
    tx: {
      ...
      auth_info: {
        signer_infos: [{ sequence: "seq" }],
        fee: { amount: [{ denom: "uluna", amount: new BigNumber(0) }] },
      },
    },
    code: 0,
    ...tx,
              ...
              attributes: [
                {
                  key: "amount",
                  value:
                    "56ibc/0025F8A87464A471E66B234C4F93AEC5B4DA3D42D7986451A059273426290DD5,512ibc/6B8A3F5C2AD51CD6171FA41A7E8C35AD594AB69226438DB94450436EA57B3A89,7uluna",
                },
                {
                  key: "validator",
