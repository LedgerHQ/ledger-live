...
describe("listOperations", () => {
  ...
  it("should fetch transactions and return operations with pagination", async () => {
    const mockTxs: Partial<TrongridTxInfo>[] = [
      { txID: "tx1", value: new BigNumber(0), date: new Date("2023-01-01T00:00:00Z"), blockHeight: 100 },
      { txID: "tx2", value: new BigNumber(42), date: new Date("2023-01-01T01:00:00Z"), blockHeight: 200 },
    ];
  ...
  it("should return cursor when hasNextPage is true", async () => {
    const mockTxs: Partial<TrongridTxInfo>[] = [
      { txID: "tx1", value: new BigNumber(0), date: new Date("2023-01-01T00:00:00Z"), blockHeight: 100 },
      { txID: "tx2", value: new BigNumber(42), date: new Date("2023-01-01T01:00:00Z"), blockHeight: 200 },
      { txID: "tx3", value: new BigNumber(50), date: new Date("2023-01-01T02:00:00Z"), blockHeight: 300 },
    ];
  ...
  it("should merge and dedupe native and trc20 transactions", async () => {
    const nativeTxs: Partial<TrongridTxInfo>[] = [
      { txID: "tx1", value: new BigNumber(0), date: new Date("2023-01-01T00:00:00Z"), blockHeight: 100 },
      { txID: "tx3", value: new BigNumber(30), date: new Date("2023-01-01T02:00:00Z"), blockHeight: 300 },
    ];
    const trc20Txs: Partial<TrongridTxInfo>[] = [
      { txID: "tx2", value: new BigNumber(20), date: new Date("2023-01-01T01:00:00Z"), blockHeight: 200 },
      { txID: "tx1", value: new BigNumber(0), date: new Date("2023-01-01T00:00:00Z"), blockHeight: 100 },
    ];
  ...
  it("should sort transactions by timestamp in ascending order", async () => {
    const mockTxs: Partial<TrongridTxInfo>[] = [
      { txID: "tx3", value: new BigNumber(30), date: new Date("2023-01-01T03:00:00Z"), blockHeight: 300 },
      { txID: "tx1", value: new BigNumber(10), date: new Date("2023-01-01T01:00:00Z"), blockHeight: 100 },
      { txID: "tx2", value: new BigNumber(20), date: new Date("2023-01-01T02:00:00Z"), blockHeight: 200 },
    ];
  ...
  it("should filter by cursor position when multiple txs share same timestamp", async () => {
    ...
    const mockTxs: Partial<TrongridTxInfo>[] = [
      ...
      { txID: "txD", value: new BigNumber(40), date: new Date("2023-01-01T02:00:00Z"), blockHeight: 200 },
    ];
  ...
  it("should use boundary operation for next cursor when endpoints have different last ops", async () => {
    const nativeTxs: Partial<TrongridTxInfo>[] = [
      { txID: "native1", value: new BigNumber(10), date: new Date("2023-01-01T01:00:00Z"), blockHeight: 100 },
      { txID: "native2", value: new BigNumber(20), date: new Date("2023-01-01T03:00:00Z"), blockHeight: 300 },
    ];
    const trc20Txs: Partial<TrongridTxInfo>[] = [
      { txID: "trc20-1", value: new BigNumber(15), date: new Date("2023-01-01T02:00:00Z"), blockHeight: 200 },
    ];
