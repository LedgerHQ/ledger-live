...
describe("Stellar Api", () => {
  ...
  describe("broadcast", () => {
    ...
    const expectedDecodedEnvelopeXdr =
      '{"envelopeType":"envelopeTypeTx","sourceAccount":"GBIVAKAFNWXYGTNXULNCP2OJRN44GYPB2FOJT6L7L5VSRSAOO65WAIT6","fee":100,"seqNum":"184704235340824581"}';
    ...
    it("maps Horizon transaction failure to StellarBroadcastFailedError with decoded fields", async () => {
      await expect(broadcastModule.broadcast(tx)).rejects.toMatchObject({
        ...
        decodedEnvelopeXdr: expectedDecodedEnvelopeXdr,
