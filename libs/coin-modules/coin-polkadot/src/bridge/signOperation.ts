...
import type { PolkadotAccount, PolkadotSigner, Transaction, TransactionStatus } from "../types";
...
export const buildSignOperation =
  ...
  ): AccountBridge<Transaction, TransactionStatus, PolkadotAccount>["signOperation"] =>
