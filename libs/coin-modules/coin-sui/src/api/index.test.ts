...
describe("api/index", () => {
  ...
  it("should call broadcast from logic", async () => {
    ...
    expect(mockBroadcast).toHaveBeenCalledWith("tx", "sui", mockConfig);
  ...
  it("should call craftTransaction via craft wrapper and return hex string", async () => {
    ...
    expect(logic.craftTransaction).toHaveBeenCalledWith(txIntent, true, undefined, mockConfig);
  });
  ...
  it("should call estimateFees via estimate wrapper and return FeeEstimation", async () => {
    ...
    expect(logic.estimateFees).toHaveBeenCalledWith(txIntent, mockConfig);
  });
  ...
  it("should call getBalance from logic", async () => {
    ...
    expect(mockGetBalance).toHaveBeenCalledWith("address", "sui", mockConfig);
  ...
  it("should call getStakes from logic", async () => {
    ...
    expect(mockGetStakes).toHaveBeenCalledWith("address", undefined, "sui", mockConfig);
