...
export function useWatchWalletSync(opts: CommonOpts): WalletSyncUserState {
  ...
  const userState = bridge.useWalletSyncUserState();
  ...
  return useMemo(
    ...
    [userState.visualPending, userState.walletSyncError],
  );
}
