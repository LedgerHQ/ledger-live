...
export type WalletState = {
  ...
  // wallet sync user state (UI state for sync operations)
  walletSyncUserState: WalletSyncUserState;
};
...
export type HandlersPayloads = {
  ...
  SET_WALLET_SYNC_USER_STATE: WalletSyncUserState;
...
export const setWalletSyncUserState = (payload: WalletSyncUserState) => ({
...
export const walletSyncUserStateSelector = (state: WalletState): WalletSyncUserState =>
  state.walletSyncUserState;
