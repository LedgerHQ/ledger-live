...
describe("toSegmentTrackEvent", () => {
  // `flow` is what dashboards slice on, and it is deliberately Ledger Wallet's word, not the
  // Earn live-app's. Pinned separately so a change has to be intentional.
