 ...
 * it must widen by deliberate edit, never on a dependency bump. `approve` and `redeem` join
 * it with the dApp/live-app parts of this work; `deposit` is already needed natively because
 * Celo splits staking into a lock leg and a vote leg.
 */
