...
export class UserId {
  ...
  exportUserIdForRecoverHash(): string {
    return this[USER_ID_SYMBOL];
  }

  exportUserIdForFirmwareSaltHash(): string {
    return this[USER_ID_SYMBOL];
  }
  ...
  exportUserIdForWalletSyncInstanceName(): string {
    return this[USER_ID_SYMBOL];
  }
  ...
  exportUserIdForSwap(): string {
    return this[USER_ID_SYMBOL];
  }

  exportUserIdForDebugDisplay(): string {
    return this[USER_ID_SYMBOL];
  }
