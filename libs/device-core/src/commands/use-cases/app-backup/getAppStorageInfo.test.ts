...
describe("getAppStorageInfo", () => {
  ...
  const response = Buffer.from([
    ...
    0x73, 0x68, 0x31, 0x32, 0x33, 0x34, 0x68, 0x61, 0x73, 0x68, 0x68, 0x61, 0x73, 0x68, 0x90, 0x00,
  ]);
  ...
  describe("parseResponse", () => {
    ...
    it("should throw TransportStatusError if the response status is invalid", () => {
      ...
      expect(() => parseResponse(data)).toThrow(new TransportStatusError(0x670a));
    });
  });
});
