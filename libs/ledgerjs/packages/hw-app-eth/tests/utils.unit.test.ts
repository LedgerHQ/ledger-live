...
describe("Eth app biding", () => {
  describe("Utils", () => {
    ...
    describe("getChainIdAsUint4", () => {
      it("should return the chainId as a 4 bytes integer", () => {
        expect(getChainIdAsUint4(1)).toEqual(1);
        expect(getChainIdAsUint4(134)).toEqual(134);
        expect(getChainIdAsUint4(new BigNumber(134))).toEqual(134);
        expect(getChainIdAsUint4(new BigNumber(10_000_000_000))).toEqual(39062500);
        expect(getChainIdAsUint4(10_000_000_000)).toEqual(39062500);
      });
    });
