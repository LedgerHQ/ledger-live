...
describe("Transaction", () => {
    it("should serialize", () => {
        ...
        const expectation = Buffer.from([
            0x00, 0x00, 0x01, 0x01, 0x01, 0x02, 0x03, 0x04, 0x05, 0x80, 0x00,
            0x00, 0x00,
        ]);
...
describe("TransactionOutput", () => {
    ...
    it("should serialize value and scriptPublicKey", () => {
        ...
        const expectation = Buffer.from([
            0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0xa1, 0xd0, 0x20, 0x11, 0xa7,
            0x21, 0x5f, 0x66, 0x8e, 0x92, 0x10, 0x13, 0xeb, 0x7a, 0xac, 0x9b,
            0x7e, 0x64, 0xb9, 0xec, 0x6e, 0x75, 0x7c, 0x1b, 0x64, 0x8e, 0x89,
            0x38, 0x8c, 0x91, 0x9f, 0x67, 0x6a, 0xa8, 0x8c, 0xac,
        ]);
