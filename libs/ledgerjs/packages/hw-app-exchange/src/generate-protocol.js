...
export const ledger_trade = $root.ledger_trade = (() => {
    ...
    ledger_trade.NewTransactionResponse = (function() {
        ...
        NewTransactionResponse.encode = function encode(message, writer) {
            ...
            if (message.amountToProvider != null && Object.hasOwnProperty.call(message, "amountToProvider"))
            ...
            if (message.deviceTransactionIdNg != null && Object.hasOwnProperty.call(message, "deviceTransactionIdNg"))
        ...
        NewTransactionResponse.verify = function verify(message) {
            ...
            if (message.payinAddress != null && message.hasOwnProperty("payinAddress"))
                if (!$util.isString(message.payinAddress))
                    return "payinAddress: string expected";
            if (message.payinExtraId != null && message.hasOwnProperty("payinExtraId"))
                if (!$util.isString(message.payinExtraId))
                    return "payinExtraId: string expected";
            ...
            if (message.refundExtraId != null && message.hasOwnProperty("refundExtraId"))
                if (!$util.isString(message.refundExtraId))
                    return "refundExtraId: string expected";
            ...
            if (message.payoutExtraId != null && message.hasOwnProperty("payoutExtraId"))
                if (!$util.isString(message.payoutExtraId))
                    return "payoutExtraId: string expected";
            if (message.currencyFrom != null && message.hasOwnProperty("currencyFrom"))
                if (!$util.isString(message.currencyFrom))
                    return "currencyFrom: string expected";
            if (message.currencyTo != null && message.hasOwnProperty("currencyTo"))
                if (!$util.isString(message.currencyTo))
                    return "currencyTo: string expected";
            if (message.amountToProvider != null && message.hasOwnProperty("amountToProvider"))
                if (!(message.amountToProvider && typeof message.amountToProvider.length === "number" || $util.isString(message.amountToProvider)))
                    return "amountToProvider: buffer expected";
            if (message.amountToWallet != null && message.hasOwnProperty("amountToWallet"))
                if (!(message.amountToWallet && typeof message.amountToWallet.length === "number" || $util.isString(message.amountToWallet)))
            ...
            if (message.deviceTransactionIdNg != null && message.hasOwnProperty("deviceTransactionIdNg"))
                if (!(message.deviceTransactionIdNg && typeof message.deviceTransactionIdNg.length === "number" || $util.isString(message.deviceTransactionIdNg)))
        ...
        NewTransactionResponse.fromObject = function fromObject(object) {
            ...
            if (object.payinExtraId != null)
                message.payinExtraId = String(object.payinExtraId);
            if (object.refundAddress != null)
                message.refundAddress = String(object.refundAddress);
            if (object.refundExtraId != null)
                message.refundExtraId = String(object.refundExtraId);
            if (object.payoutAddress != null)
                message.payoutAddress = String(object.payoutAddress);
            if (object.payoutExtraId != null)
                message.payoutExtraId = String(object.payoutExtraId);
            if (object.currencyFrom != null)
                message.currencyFrom = String(object.currencyFrom);
            if (object.currencyTo != null)
                message.currencyTo = String(object.currencyTo);
            if (object.amountToProvider != null)
                if (typeof object.amountToProvider === "string")
                    $util.base64.decode(object.amountToProvider, message.amountToProvider = $util.newBuffer($util.base64.length(object.amountToProvider)), 0);
            ...
            if (object.amountToWallet != null)
                if (typeof object.amountToWallet === "string")
                    $util.base64.decode(object.amountToWallet, message.amountToWallet = $util.newBuffer($util.base64.length(object.amountToWallet)), 0);
                else if (object.amountToWallet.length >= 0)
                    message.amountToWallet = object.amountToWallet;
            ...
            if (object.deviceTransactionIdNg != null)
                if (typeof object.deviceTransactionIdNg === "string")
                    $util.base64.decode(object.deviceTransactionIdNg, message.deviceTransactionIdNg = $util.newBuffer($util.base64.length(object.deviceTransactionIdNg)), 0);
        ...
        NewTransactionResponse.toObject = function toObject(message, options) {
            ...
            if (message.amountToProvider != null && message.hasOwnProperty("amountToProvider"))
                object.amountToProvider = options.bytes === String ? $util.base64.encode(message.amountToProvider, 0, message.amountToProvider.length) : options.bytes === Array ? Array.prototype.slice.call(message.amountToProvider) : message.amountToProvider;
            if (message.amountToWallet != null && message.hasOwnProperty("amountToWallet"))
                object.amountToWallet = options.bytes === String ? $util.base64.encode(message.amountToWallet, 0, message.amountToWallet.length) : options.bytes === Array ? Array.prototype.slice.call(message.amountToWallet) : message.amountToWallet;
            if (message.deviceTransactionId != null && message.hasOwnProperty("deviceTransactionId"))
                object.deviceTransactionId = message.deviceTransactionId;
            if (message.deviceTransactionIdNg != null && message.hasOwnProperty("deviceTransactionIdNg"))
                object.deviceTransactionIdNg = options.bytes === String ? $util.base64.encode(message.deviceTransactionIdNg, 0, message.deviceTransactionIdNg.length) : options.bytes === Array ? Array.prototype.slice.call(message.deviceTransactionIdNg) : message.deviceTransactionIdNg;
            return object;
        };
    ...
    ledger_trade.UDecimal = (function() {
        ...
        UDecimal.verify = function verify(message) {
            ...
            if (message.coefficient != null && message.hasOwnProperty("coefficient"))
                if (!(message.coefficient && typeof message.coefficient.length === "number" || $util.isString(message.coefficient)))
        ...
        UDecimal.fromObject = function fromObject(object) {
            ...
            if (object.coefficient != null)
                ...
                else if (object.coefficient.length >= 0)
        ...
        UDecimal.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                if (options.bytes === String)
                    ...
                    object.coefficient = [];
                    if (options.bytes !== Array)
                        object.coefficient = $util.newBuffer(object.coefficient);
                }
                object.exponent = 0;
            }
            if (message.coefficient != null && message.hasOwnProperty("coefficient"))
                object.coefficient = options.bytes === String ? $util.base64.encode(message.coefficient, 0, message.coefficient.length) : options.bytes === Array ? Array.prototype.slice.call(message.coefficient) : message.coefficient;
            if (message.exponent != null && message.hasOwnProperty("exponent"))
    ...
    ledger_trade.NewSellResponse = (function() {
        ...
        NewSellResponse.verify = function verify(message) {
            ...
            if (message.traderEmail != null && message.hasOwnProperty("traderEmail"))
                if (!$util.isString(message.traderEmail))
                    return "traderEmail: string expected";
            if (message.inCurrency != null && message.hasOwnProperty("inCurrency"))
                if (!$util.isString(message.inCurrency))
                    return "inCurrency: string expected";
            if (message.inAmount != null && message.hasOwnProperty("inAmount"))
                if (!(message.inAmount && typeof message.inAmount.length === "number" || $util.isString(message.inAmount)))
                    return "inAmount: buffer expected";
            if (message.inAddress != null && message.hasOwnProperty("inAddress"))
                if (!$util.isString(message.inAddress))
                    return "inAddress: string expected";
            ...
            if (message.deviceTransactionId != null && message.hasOwnProperty("deviceTransactionId"))
                if (!(message.deviceTransactionId && typeof message.deviceTransactionId.length === "number" || $util.isString(message.deviceTransactionId)))
                    return "deviceTransactionId: buffer expected";
            if (message.inExtraId != null && message.hasOwnProperty("inExtraId"))
                if (!$util.isString(message.inExtraId))
                    return "inExtraId: string expected";
            return null;
        };
        ...
        NewSellResponse.fromObject = function fromObject(object) {
            ...
            if (object.inCurrency != null)
                message.inCurrency = String(object.inCurrency);
            if (object.inAmount != null)
                if (typeof object.inAmount === "string")
                    $util.base64.decode(object.inAmount, message.inAmount = $util.newBuffer($util.base64.length(object.inAmount)), 0);
                else if (object.inAmount.length >= 0)
                    message.inAmount = object.inAmount;
            if (object.inAddress != null)
                message.inAddress = String(object.inAddress);
            if (object.outCurrency != null)
            ...
            if (object.deviceTransactionId != null)
                if (typeof object.deviceTransactionId === "string")
                    $util.base64.decode(object.deviceTransactionId, message.deviceTransactionId = $util.newBuffer($util.base64.length(object.deviceTransactionId)), 0);
                else if (object.deviceTransactionId.length >= 0)
                    message.deviceTransactionId = object.deviceTransactionId;
            if (object.inExtraId != null)
                message.inExtraId = String(object.inExtraId);
            return message;
        };
        ...
        NewSellResponse.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if (options.bytes === String)
                    ...
                    object.inAmount = [];
                    if (options.bytes !== Array)
                        object.inAmount = $util.newBuffer(object.inAmount);
                }
                object.inAddress = "";
                object.outCurrency = "";
            ...
            if (message.inAmount != null && message.hasOwnProperty("inAmount"))
                object.inAmount = options.bytes === String ? $util.base64.encode(message.inAmount, 0, message.inAmount.length) : options.bytes === Array ? Array.prototype.slice.call(message.inAmount) : message.inAmount;
            if (message.inAddress != null && message.hasOwnProperty("inAddress"))
