...
function SSV({ size = 16, color = DefaultColor }) {
    return React.createElement(Svg, { width: size, height: size, viewBox: "0 0 512 512", fill: color },
        React.createElement("path", { opacity: 0.62, d: "M177.641 404.919l64.585-79.604c6.746-8.316 19.435-8.316 26.181 0l64.584 79.604a16.857 16.857 0 010 21.241l-64.584 79.604c-6.746 8.315-19.435 8.315-26.181 0l-64.585-79.604a16.86 16.86 0 010-21.241z" }),
