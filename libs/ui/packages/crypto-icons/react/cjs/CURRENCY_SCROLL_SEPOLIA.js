...
var CURRENCY_SCROLL_SEPOLIA_exports = {};
__export(CURRENCY_SCROLL_SEPOLIA_exports, {
  default: () => CURRENCY_SCROLL_SEPOLIA_default
});
module.exports = __toCommonJS(CURRENCY_SCROLL_SEPOLIA_exports);
var React = __toESM(require("react"));
var import_StyledSvg = __toESM(require("./StyledSvg"));
const DefaultColor = "#000";
function CURRENCY_SCROLL_SEPOLIA({
  size = 16,
  color = DefaultColor
}) {
...
var CURRENCY_SCROLL_SEPOLIA_default = CURRENCY_SCROLL_SEPOLIA;
