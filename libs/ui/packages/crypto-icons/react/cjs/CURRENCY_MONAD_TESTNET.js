...
var CURRENCY_MONAD_TESTNET_exports = {};
__export(CURRENCY_MONAD_TESTNET_exports, {
  default: () => CURRENCY_MONAD_TESTNET_default
});
module.exports = __toCommonJS(CURRENCY_MONAD_TESTNET_exports);
var React = __toESM(require("react"));
var import_StyledSvg = __toESM(require("./StyledSvg"));
const DefaultColor = "#6E54FF";
function CURRENCY_MONAD_TESTNET({
  size = 16,
  color = DefaultColor
}) {
...
CURRENCY_MONAD_TESTNET.DefaultColor = DefaultColor;
var CURRENCY_MONAD_TESTNET_default = CURRENCY_MONAD_TESTNET;
//# sourceMappingURL=CURRENCY_MONAD_TESTNET.js.map
