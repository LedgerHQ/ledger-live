...
var CURRENCY_POLYGON_ZK_EVM_exports = {};
__export(CURRENCY_POLYGON_ZK_EVM_exports, {
  default: () => CURRENCY_POLYGON_ZK_EVM_default
});
module.exports = __toCommonJS(CURRENCY_POLYGON_ZK_EVM_exports);
var React = __toESM(require("react"));
var import_StyledSvg = __toESM(require("./StyledSvg"));
const DefaultColor = "#8247e5";
function CURRENCY_POLYGON_ZK_EVM({
  size = 16,
  color = DefaultColor
}) {
...
CURRENCY_POLYGON_ZK_EVM.DefaultColor = DefaultColor;
var CURRENCY_POLYGON_ZK_EVM_default = CURRENCY_POLYGON_ZK_EVM;
//# sourceMappingURL=CURRENCY_POLYGON_ZK_EVM.js.map
