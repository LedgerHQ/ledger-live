...
function MEETONE({ size = 16, color = DefaultColor }) {
    return React.createElement(Svg, { width: size, height: size, viewBox: "0 0 24 24", fill: color },
        React.createElement(Path, { fillOpacity: 0.7, d: "M6.483 16.985l5.217 3.282h.631l5.133-3.282-.8-.63-4.67 2.987-4.838-2.987zm2.524-7.614l2.946-4.46 3.029 4.502.715-.632-3.366-5.048s-.294-.379-.757 0l-3.45 5.175z" }),
