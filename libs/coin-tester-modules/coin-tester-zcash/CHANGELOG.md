...
- [#22104](https://github.com/LedgerHQ/ledger-live/pull/22104) [`1da4222`](https://github.com/LedgerHQ/ledger-live/commit/1da42226b680a131ad642c516cf04d0e34bb5d67) Thanks [@pawell24](https://github.com/pawell24)! - Limit `test` and `coverage` to the signer unit tests so the Docker regtest scenario no longer runs during coverage.
