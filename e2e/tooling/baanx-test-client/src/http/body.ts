...
/**
 * Whether Baanx's own 401 message reads as a lock rather than a bad password.
 *
 * A guess at free text we do not control, so it only ever *adds* detail to
 * `BaanxInvalidCredentialsError` — a miss still reports invalid credentials.
 */
