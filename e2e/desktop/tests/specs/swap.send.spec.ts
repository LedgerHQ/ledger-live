...
const swaps = [
  ...
  },
  {
    ...
    tag: ["@NanoSP", "@LNS", "@NanoX", "@Stax", "@Flex", "@NanoGen5", "@xrp", "@bitcoin"],
  },
  ...
  //   tag: ["@NanoSP", "@NanoX", "@Stax", "@Flex", "@NanoGen5", "@aptos", "@solana"],
  // },
  ...
  //  tag: ["@NanoSP", "@NanoX", "@Stax", "@Flex", "@NanoGen5", "@hedera", "@xrp"],
  //},
  {
    fromAccount: TokenAccount.SUI_USDC_1,
    toAccount: Account.SOL_1,
    xrayTicket: "B2CQA-3907",
    tag: ["@NanoSP", "@NanoX", "@Stax", "@Flex", "@NanoGen5", "@sui", "@solana"],
  },
  {
    fromAccount: TokenAccount.CELO_1,
    toAccount: Account.SOL_1,
    xrayTicket: "B2CQA-4011",
    tag: ["@NanoSP", "@NanoX", "@Stax", "@Flex", "@NanoGen5", "@celo", "@solana"],
  },
];
