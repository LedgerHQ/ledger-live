...
export class Drawer extends Component {
  ...
  private readonly drawerOverlay = this.page.locator(
    "[data-testid='drawer-overlay'][style='opacity: 1;']",
  );
  private readonly closeButton = this.page.getByTestId("drawer-close-button");
