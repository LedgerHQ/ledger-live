...
export class ModularDrawer extends Drawer {
  ...
  async selectAssetByTickerAndName(currency: Currency, assetCountToValidate?: number) {
    return await this.assetDrawer.selectAssetByName(currency, assetCountToValidate);
  }
