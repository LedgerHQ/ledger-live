...
export class TezosEarningChoiceModal extends Modal {
  private delegateButton = this.page.getByTestId("tezos-earn-choice-delegate-button");
  private stakeButton = this.page.getByTestId("tezos-earn-choice-stake-button");
