...
exports.Rate = exports.BuySellProvider = exports.EarnProvider = exports.SwapProvider = exports.BaseProvider = void 0;
...
class SwapProvider extends BaseProvider {
    kyc;
    availableOnLns;
    contractAddress;
    app;
    ...
    static UNISWAP = new SwapProvider("uniswap", "Uniswap", false, false, "0x000000000022D473030F116dDEE9F6B43aC78BA3", AppInfos_1.AppInfos.ETHEREUM);
    static ONE_INCH = new SwapProvider("oneinch", "1inch", false, true, "0x111111125421cA6dc452d289314280a0f8842A65", AppInfos_1.AppInfos.ONE_INCH);
    static VELORA = new SwapProvider("velora", "Velora", false, true, "0x6A000F20005980200259B80c5102003040001068", AppInfos_1.AppInfos.VELORA);
    static OKX = new SwapProvider("okx", "OKX", false, false, "0x40aA958dd87FC8305b97f2BA922CDdCa374bcD7f", AppInfos_1.AppInfos.ETHEREUM);
}
exports.SwapProvider = SwapProvider;
class EarnProvider extends BaseProvider {
...
exports.EarnProvider = EarnProvider;
class BuySellProvider extends BaseProvider {
    isTested;
...
exports.BuySellProvider = BuySellProvider;
var Rate;
(function (Rate) {
    Rate["FIXED"] = "fixed";
    Rate["FLOAT"] = "float";
