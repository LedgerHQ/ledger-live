...
exports.delegateAptos = exports.sendAptos = void 0;
...
exports.sendAptos = (0, DeviceController_1.withDeviceController)(({ getButtonsController }) => async (tx) => {
...
exports.delegateAptos = (0, DeviceController_1.withDeviceController)(({ getButtonsController }) => async (delegatingAccount) => {
    const buttons = getButtonsController();
