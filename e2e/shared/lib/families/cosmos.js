...
exports.sendCosmos = exports.delegateCosmos = void 0;
...
exports.delegateCosmos = (0, DeviceController_1.withDeviceController)(({ getButtonsController }) => async (delegatingAccount) => {
...
exports.sendCosmos = (0, DeviceController_1.withDeviceController)(({ getButtonsController }) => async (tx) => {
    const buttons = getButtonsController();
