...
export const delegateSolana = withDeviceController(({ getButtonsController }) => async (delegatingAccount) => {
...
export const sendSolana = withDeviceController(({ getButtonsController }) => async (tx) => {
    const buttons = getButtonsController();
