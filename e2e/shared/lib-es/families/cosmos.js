...
export const delegateCosmos = withDeviceController(({ getButtonsController }) => async (delegatingAccount) => {
...
export const sendCosmos = withDeviceController(({ getButtonsController }) => async (tx) => {
    const buttons = getButtonsController();
