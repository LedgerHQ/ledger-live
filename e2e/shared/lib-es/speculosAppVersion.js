...
export function isTouchDevice() {
    ...
    return (model === DeviceModelId.stax || model === DeviceModelId.europa || model === DeviceModelId.apex);
}
...
export async function getNanoAppCatalog(device, deviceFirmware) {
...
export async function getDeviceFirmwareVersion(device) {
...
export async function createNanoAppJsonFile(nanoAppFilePath) {
...
export async function getNanoAppCatalogVersionMap(nanoAppFilePath) {
    const jsonFilePath = path.resolve(process.cwd(), nanoAppFilePath);
    try {
...
export async function getAppVersionFromCatalog(currency, nanoAppFilePath) {
    try {
