...
export async function getMinimumSwapAmount(accountFrom, accountTo, providersWhitelist) {
    try {
...
export async function pickRotatingProvider(eligibleProviders, accountFrom, accountTo) {
