...
import type { CounterValuesState, PairRateMapCache, RateMap, RateMapStats } from "./types";
...
/** The mock table reduced to ticker -> value in BTC, computed once. */
export function getBTCValues(): Record<string, number> {
