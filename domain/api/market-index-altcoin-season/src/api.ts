 ...
 * endpoint below.
 */
export const altcoinSeasonApi = coinMarketCapApi
...
export const { useGetAltcoinSeasonIndexLatestQuery } = altcoinSeasonApi;

export type AltcoinSeasonApi = typeof altcoinSeasonApi;
