...
| Partner signatures (CAL) | `global.api.prd.ledger.com/cal`<br>_staging: `global.api.stg.ledger-test.com/cal`_ | [env](/libs/env/src/env.ts) | prod |
...
| Crypto Assets List (CAL) | `global.api.prd.ledger.com/cal`<br>_staging: `global.api.stg.ledger-test.com/cal`_ | [env](/libs/env/src/env.ts) | prod |
