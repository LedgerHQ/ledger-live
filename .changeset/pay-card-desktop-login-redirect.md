...
The login block also takes its copy from the translations instead of hardcoded English, and it renders the logged-out design: a title, a description, and one centred action.
