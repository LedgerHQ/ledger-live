...
// Lumen's shared utils (`cn`, the amount formatters) and its design tokens ship as ESM and are
...
const nativeMocks = {
  ...
  "^react-native-draggable-flatlist$": path.join(__dirname, "mocks/draggable-flatlist.js"),
