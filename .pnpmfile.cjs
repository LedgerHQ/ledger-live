const { process, removePeerDeps, addDependencies } = require("./tools/pnpm-utils")
...
function readPackage(pkg, context) {
  ...
  process([
    ...
    addDependencies("@svgr/core", { "@svgr/plugin-svgo": "*" }, { kind: "peerDependencies" }),
    ...
    addDependencies("any-observable", {
      "rxjs": "*"
    }, {
